...
{
    [ToolboxItem(false)]
    public class FLActivityToolbox : Panel, IToolboxService
    {
        ...
        public FLActivityToolbox(IServiceProvider provider)
        {
        ...
        public CategoryNameCollection CategoryNames
        {
            get
            {
                return new CategoryNameCollection(new string[] { "Windows Forms" });
            }
        }
        ...
        public virtual ToolboxItem GetSelectedToolboxItem()
        {
            ...
            if (this.currentSelection != null)
            {
                try
                {
                    toolClass = FLActivityToolbox.GetToolboxItem(this.currentSelection);
                }
        ...
        private void AddToolboxEntries(ListBox lb)
        {
            try
            {
                List<FLActivityInfo> toolboxItems = ConfigurationManager.GetSection("FLDesigner.DynamicUpdate/toolboxItems") as List<FLActivityInfo>;
                if (toolboxItems != null)
                {
                    foreach (FLActivityInfo workflowActivityType in toolboxItems)
        ...
        private void OnListBoxMouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left && this.listBox.SelectedItem != null)
            {
                ...
                ToolboxItem toolboxItem = FLActivityToolbox.GetToolboxItem(selectedItem.ComponentClass);
        ...
        //        if (docDes != null)
        //        {
        //            ToolboxItem c = FLActivityToolbox.GetToolboxItem(this.currentSelection);
