...
namespace MWizard
{
    //这个文件为兼容VS2012新ExtWizard增加的,只考虑实现功能，不考虑代码优化
    public partial class TExtWebClientGenerator
    {
#if VS90
        /// <summary>
        /// "Infolight"字串
        ...
        private void GenMainBlockControl_3(TBlockItem blockItem, String formViewName)
        {
            ...
            if (AjaxFromView1 != null)
            {
                ...
                foreach (TBlockFieldItem BFI in blockItem.BlockFieldItems)
                {
                    ...
                    if (BFI.DefaultValue != null && BFI.DefaultValue != String.Empty)
