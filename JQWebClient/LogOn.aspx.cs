...
public partial class LogOn : System.Web.UI.Page
{
    ...
    private void LoadCookie()
    {
        ...
        {
            (Login1.FindControl("Password") as TextBox).Attributes.Add("value", GetPwdString(System.Web.HttpUtility.UrlDecode(password)));
    ...
    {
        Page.Response.Redirect("InnerPages/ResetPWD.aspx?db=" + SelectedDataBase);
    }
}
