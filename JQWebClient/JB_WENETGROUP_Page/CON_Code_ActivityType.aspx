<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CON_Code_ActivityType.aspx.cs" Inherits="Template_JQuerySingle1" %>
...
<head runat="server">
    ...
    <script>
        ...
        function gridReload(rows) {
            if (rows) {
                name = rows.NAME;
                $("#dataGridMaster").datagrid('setWhere', "FIELDNAME = 'ACTIVITY_TYPE'");
        ...
        function checkName(val) {
            if (insertFlag == true || o_name != val) {
                ...
                $.ajax({
                    ...
                    data: "mode=method&method=" + "checkName" + "&parameters=" + "ACTIVITY_TYPE" + "," + name, //method後的參數為server的Method名稱  parameters後為端的到後端的參數這裡傳入選中資料的CustomerID欄位
                    cache: false,
                    async: false,
        ...
        function checkShareCodeRowCount(row) {
            ...
            $.ajax({
                ...
                data: "mode=method&method=" + "checkShareCodeRowCount" + "&parameters=" + 'ACTIVITY_TYPE' + "," + row.CODE_ID, //method後的參數為server的Method名稱  parameters後為端的到後端的參數這裡傳入選中資料的CustomerID欄位
                cache: false,
                async: false,
                success: function (data) {
                    if (data != false) {
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="_CON_SHARECODE.CON_SHARECODE" runat="server" AutoApply="True"
                ...
                <Columns>
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="活動類型名稱" Editor="text" FieldName="NAME" Format="" MaxLength="200" Width="250" Sortable="True" />
                ...
                <QueryColumns>
                    <JQTools:JQQueryColumn Caption="活動類型名稱" Condition="%%" DataType="string" Editor="text" FieldName="NAME" NewLine="True" RemoteMethod="False" Width="125" />
                </QueryColumns>
            </JQTools:JQDataGrid>
        </div>
        <JQTools:JQDefault runat="server" BindingObjectID="dataGridMaster" EnableTheming="True" ID="defaultMaster">
            <Columns>
                ...
                <JQTools:JQDefaultColumn CarryOn="False" DefaultValue="ACTIVITY_TYPE" FieldName="FIELDNAME" RemoteMethod="True" />
            </Columns>
        </JQTools:JQDefault>
            ...
            <div class="div_RelativeLayout">
                <JQTools:JQDataGrid ID="DG_CON_SHARECODE_LOG" runat="server" RemoteName="_CON_SHARECODE.CON_SHARECODE_LOG" AllowAdd="False" AllowDelete="False" AllowUpdate="False" AlwaysClose="True" AutoApply="False" CheckOnSelect="True" ColumnsHibeable="False" DataMember="CON_SHARECODE_LOG" DeleteCommandVisible="False" DuplicateCheck="False" EditMode="Dialog" EditOnEnter="True" InsertCommandVisible="False" MultiSelect="False" PageList="10,20,30,40,50" PageSize="10" Pagination="True" QueryAutoColumn="False" QueryLeft="" QueryMode="Window" QueryTitle="Query" QueryTop="" RecordLock="False" RecordLockMode="None" Title="" TotalCaption="Total:" UpdateCommandVisible="False" ViewCommandVisible="False">
                    <Columns>
                        ...
                        <JQTools:JQGridColumn Alignment="left" Caption="活動類型名稱" Editor="text" FieldName="NAME" Format="" MaxLength="200" Width="180" Sortable="True" />
