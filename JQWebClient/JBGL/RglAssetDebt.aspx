    ...
    <title></title>
     <script>     
         ...
         function queryGrid(dg) {//查詢後添加固定條件
             ...
             var url = "../JBGL/REPORT/RglAssetDebtReportView.aspx?EDate=" + JQDate1 + "&CompanyID=" + CompanyID + "&VoucherID=" + VoucherID +
                 "&iType=" + iType + "&CompanyText=" + CompanyText;
