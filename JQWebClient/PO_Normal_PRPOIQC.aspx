...
<head runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //紅字
            var redfields2 = ['PurVendor1', 'POPayTypeID', 'Installments', 'PurDocVen1','IsCatalogue'];//
            ...
            var redfields0 = ['DeliveryQty', 'DeliveryDate', 'PurPrice', 'TotalPrice', 'PayWayID', 'AcceptanceDate', 'AcceptanceQty', 'Surveyors', 'DebtorDays', 'ProofTypeID', 'AssetLocaID'];
        ...
        function dataFormMaster_OnLoadSuccess() {
            ...
            var HiddenMasterFields = ['ResponsibleGROUPID', 'FlagDeliveryEnough', 'D_STEP_ID', 'sysVariable', 'Acno', 'SubAcno', 'ApplyOrg_NO', 'Flowflag', 'Installments', 'IsCatalogue','OtherFee', 'OtherFeeTax'];
            ...
            if (parameter == "" && (getEditMode($("#dataFormMaster")) == 'inserted' || getEditMode($("#dataFormMaster")) == 'updated' || (getEditMode($("#dataFormMaster")) == 'viewed' && $("#dataFormMasterFlowflag").val()==""))) {
                ...
                //隱藏交貨明細的欄位
                var HiddenDeliveryFields = ['PurPrice', 'OtherFee', 'TotalPrice', 'DebtorDays', 'InvoiceNO', 'AcceptanceQty', 'PayWayID', 'AcceptanceDate', 'Surveyors', 'ReturnQty', 'AcceptanceTax','AccountNO','ProofTypeID'];
                ...
                $('input[name="PrDoc"]').attr('disabled', false);
                //財產目錄
                ShowFields('#dataFormMaster', ['IsCatalogue']);
        ...
        function dataFormMaster_OnApply() {
            ...
            if ((parameter == 'S6' || parameter == 'S4') && (getEditMode($("#dataFormMaster")) == 'updated')) {
                ...
                if (flag == false) { alert('提醒您，交貨項次:' + arrAlert.join(',') + "已驗收，但未填結帳資料"); }
            }
            //(請購單申請)新增時，卡明細至少一筆
        ...
        function dataFormDelivery_OnApply() {
            ...
            if ((parameter == 'S6' || parameter == 'S4') && (getEditMode($("#dataFormDelivery")) == 'inserted')) {
                ...
                if ($.trim($("#dataFormDeliveryInvoiceNO").val()) == '' && ($("#dataFormDeliveryProofTypeID").combobox('getValue') == '1')) {//憑據號碼
                    ...
                    alert("物品單價為必填");
                    return false;
                } else if ($.trim($("#dataFormDeliveryTotalPrice").val()) == '') {//總價
                    alert("總價為必填");
                    return false;
                    //付款方式
        ...
        function PayTo_OnSelect(rowdata) {
            ...
            $("#dataFormDeliveryAccountNO").val(rowdata.VendAccount);//匯款帳號
        ...
        function queryGrid(dg) {
            if ($(dg).attr('id') == 'dataGridView') {
                ...
                if (aVal != '') {
                    result.push("(PONO like '%" + aVal + "%' or ApplyUserID like '%" + aVal + "%' or Description like '%" + aVal + "%')");
                }
        ...
        function GetOrgNO_CostCenterID(OrgNO) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    var rows = $.parseJSON(data);
                    if (rows.length > 0) {
                        returnValue = rows[0].glCostCenterID;
                    }
                }
            }
            );
        ...
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sPO_Normal_PRPOIQC.POMaster" runat="server" AutoApply="True"
                ...
                <Columns>
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="申請日期" Editor="text" FieldName="ApplyDate" Format="yyyy-mm-dd" Visible="true" Width="60" />
                    <JQTools:JQGridColumn Alignment="left" Caption="申請者" Editor="infocombobox" FieldName="ApplyUserID" Format="" MaxLength="20" Visible="true" Width="50" EditorOptions="valueField:'USERID',textField:'USERNAME',remoteName:'sPO_Normal_PRPOIQC.Users',tableName:'Users',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" />
                    <JQTools:JQGridColumn Alignment="left" Caption="流程作業" Editor="text" FieldName="D_STEP_ID" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="80">
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="請購說明" Editor="text" FieldName="Description" Format="" MaxLength="256" Visible="true" Width="180" />
                ...
                <QueryColumns>
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="請購單號、申請者工號、請購說明" Condition="%" DataType="string" Editor="text" FieldName="VirtualColumn" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
                    <JQTools:JQQueryColumn AndOr="and" Caption="物品名稱" Condition="%" DataType="string" Editor="text" FieldName="VirtualColumn1" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
                </QueryColumns>
            </JQTools:JQDataGrid>
            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title=" " Width="1140px" DialogTop="10px" DialogLeft="10px">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="POMaster" HorizontalColumnsCount="3" RemoteName="sPO_Normal_PRPOIQC.POMaster" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalGap="0" IsAutoPageClose="True" IsAutoPause="False" IsAutoSubmit="True" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="True" OnLoadSuccess="dataFormMaster_OnLoadSuccess" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" OnApply="dataFormMaster_OnApply" OnApplied="DFM_OnApplied" OnCancel="dataFormMaster_OnCancel" >
                    ...
                    <Columns>
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="請購說明" Editor="textarea" FieldName="Description" Format="" NewRow="True" Span="3" Width="658" />
                ...
                <JQTools:JQDataGrid ID="dataGridDetail" runat="server" AutoApply="False" DataMember="PODetails" EditDialogID="JQDialog2" Pagination="False" ParentObjectID="dataFormMaster" RemoteName="sPO_Normal_PRPOIQC.POMaster" Title="請採購明細" AllowAdd="True" AllowDelete="True" AllowUpdate="True" AlwaysClose="False" BufferView="False" CheckOnSelect="True" ColumnsHibeable="False" DeleteCommandVisible="True" DuplicateCheck="False" EditMode="Dialog" EditOnEnter="True" InsertCommandVisible="True" MultiSelect="False" NotInitGrid="False" PageList="10,20,30,40,50" PageSize="10" QueryAutoColumn="False" QueryLeft="" QueryMode="Window" QueryTitle="Query" QueryTop="" RecordLock="False" RecordLockMode="None" RowNumbers="True" TotalCaption="Total:" UpdateCommandVisible="True" ViewCommandVisible="True" OnInsert="dataGridDetail_OnInsert" OnDeleted="dataGridDetail_OnDeleted" OnDelete="DGDetail_OnDelete" OnLoadSuccess="dataGridDetail_OnLoad" OnUpdate="DGDetail_OnUpdate" >
                    ...
                    <Columns>
                        ...
                        <JQTools:JQGridColumn Alignment="left" Caption="項次" Editor="text" FieldName="ItemNO" Width="30" MaxLength="10" Visible="True" />
                ...
                <JQTools:JQDialog ID="JQDialog2" runat="server" BindingObjectID="dataFormDetail" Title="請採購明細" Width="980px" DialogLeft="47px" DialogTop="197px">
                    <JQTools:JQDataForm ID="dataFormDetail" runat="server" ParentObjectID="dataFormMaster" DataMember="PODetails" HorizontalColumnsCount="3" RemoteName="sPO_Normal_PRPOIQC.POMaster" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" OnApply="dataFormDetail_OnApply" OnLoadSuccess="dataFormDetail_OnLoadSuccess" >
                        <Columns>
                            ...
                            <JQTools:JQFormColumn Alignment="left" Caption="項次" Editor="text" FieldName="ItemNO" Format="" Width="120" ReadOnly="True" Span="2" NewRow="False" />
                            ...
                            <JQTools:JQFormColumn Alignment="center" Caption="資產" Editor="checkbox" FieldName="IsAsset" Width="35" NewRow="False" Span="1" MaxLength="0" ReadOnly="True" RowSpan="1" Visible="True" />
                            <JQTools:JQFormColumn Alignment="left" Caption="物品規格" Editor="textarea" FieldName="ItemSpec" Format="" Width="540" NewRow="True" Span="3" />
                            ...
                            <JQTools:JQFormColumn Alignment="left" Caption="需求日期" Editor="datebox" FieldName="RegDate" NewRow="True" Width="120" EditorOptions="dateFormat:'datetime',showTimeSpinner:false,showSeconds:true,editable:false" Format="" OnBlur="dataFormDetailRegDate_OnBlur" />
                ...
                <JQTools:JQDataGrid ID="dataGridDelivery" runat="server" AllowAdd="True" AllowDelete="True" AllowUpdate="True" AlwaysClose="False" AutoApply="False" BufferView="False" CheckOnSelect="True" ColumnsHibeable="False" DataMember="PODelivery" DeleteCommandVisible="True" DuplicateCheck="False" EditDialogID="JQDialog3" EditMode="Dialog" EditOnEnter="True" InsertCommandVisible="True" MultiSelect="False" NotInitGrid="False" PageList="10,20,30,40,50" PageSize="10" Pagination="False" ParentObjectID="dataFormMaster" QueryAutoColumn="False" QueryLeft="" QueryMode="Window" QueryTitle="Query" QueryTop="" RecordLock="False" RecordLockMode="None" RemoteName="sPO_Normal_PRPOIQC.POMaster" RowNumbers="True" Title="交貨明細(新增前，請先點選請採購明細任一筆)" TotalCaption="合計" UpdateCommandVisible="True" ViewCommandVisible="True" OnInsert="dataGridDelivery_OnInsert" OnDelete="DGDelivery_OnDelete" OnUpdate="DGDelivery_OnUpdate" OnLoadSuccess="dataGridDelivery_OnLoad">
                    <Columns>
                        ...
                        <JQTools:JQGridColumn Alignment="left" Caption="交貨項次" Editor="text" FieldName="DeliveryNO" MaxLength="10" Width="50" Visible="True" />
                        <JQTools:JQGridColumn Alignment="left" Caption="請購項次" Editor="text" FieldName="ItemNO" MaxLength="10" Width="50" />
                        ...
                        <JQTools:JQGridColumn Alignment="right" Caption="交貨數量" Editor="text" FieldName="DeliveryQty" MaxLength="4" Width="50" />
                        <JQTools:JQGridColumn Alignment="right" Caption="驗收數量" Editor="numberbox" FieldName="AcceptanceQty" MaxLength="0" Width="50" Visible="True" />
                        <JQTools:JQGridColumn Alignment="right" Caption="退貨數量" Editor="text" FieldName="ReturnQty" MaxLength="0" Width="50" Visible="True" />
                        ...
                        <JQTools:JQGridColumn Alignment="left" Caption="總價" Editor="text" FieldName="TotalAmount" MaxLength="0" Width="80" Visible="True" Total="sum" OnTotal="" />
                        ...
                        <JQTools:JQGridColumn Alignment="left" Caption="會計已審" Editor="text" FieldName="IsAPCompleted" Format="L-V-" MaxLength="0" Visible="True" Width="50" />
                    </Columns>
                    <RelationColumns>
                        <JQTools:JQRelationColumn FieldName="PONO" ParentFieldName="PONO" />
                    </RelationColumns>
