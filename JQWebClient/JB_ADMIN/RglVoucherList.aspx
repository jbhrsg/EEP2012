    ...
    <title></title>
     <script>     
         ...
         function queryGrid(dg) {//查詢後添加固定條件
             ...
             var SubAcno2 = $('#SubAcno2_Query').val();

             var VoucherNo = $('#VoucherNo_Query').val();
             var CostCenterID = $("#CostCenterID_Query").combobox('getValue');
             var iType = $('#CreateBy_Query').options('getValue');// 1傳票清單 2日記帳 3分類帳  4分類帳-不分頁 5分類帳-不分群組

             //報表用參數
             var TypeText = $('#CreateBy_Query').options('getText'); 
...
&nbsp;<div id="Dialog_dataGridMasterData">
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="sRglVoucherList.glVoucherList" runat="server" AutoApply="True"
                ...
                <QueryColumns>
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="會計科目" Condition="=" DataType="string" Editor="text" FieldName="Acno" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="0" Width="60" />
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="子科目" Condition="=" DataType="string" Editor="text" FieldName="SubAcno" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="60" />
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="報表類型" Condition="=" DataType="string" Editor="infooptions" EditorOptions="title:'JQOptions',panelWidth:200,remoteName:'',tableName:'',valueField:'',textField:'',columnCount:7,multiSelect:false,openDialog:false,selectAll:false,selectOnly:true,items:[{text:'傳票清單',value:'1'},{text:'日記帳',value:'2'},{text:'分類帳',value:'3'},{text:'分類帳-不分頁',value:'4'},{text:'分類帳-不分群組',value:'5'},{text:'總分類帳-明細式',value:'6'},{text:'總分類帳-統製式',value:'7'}]" FieldName="CreateBy" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="5" Width="200" />
                </QueryColumns>
            </JQTools:JQDataGrid>
            </div>
        </div>
