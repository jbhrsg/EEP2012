    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {                
                ...
                ReportViewer1.LocalReport.DisplayName = JobName;

                string ReportPath = "JB_ADMIN/REPORT/JBHunter/JobNARReport.rdlc";//報表路徑
                ...
                var obj = client.CallMethod(EFClientTools.ClientUtility.ClientInfo, "sCustomersJobs", "procReportJobNAR", parameters);
                DataTable dt = new DataTable();
                dt = JsonConvert.DeserializeObject<DataTable>(obj.ToString());

                var parameters2 = new List<object>();
                parameters2.Add(JobID + "," + 2);
                var obj2 = client.CallMethod(EFClientTools.ClientUtility.ClientInfo, "sCustomersJobs", "procReportJobNAR", parameters2);
                ...
                this.ReportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("HUT_Job", dt));
                this.ReportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("HUT_JobRequirementRecord", dt2));
