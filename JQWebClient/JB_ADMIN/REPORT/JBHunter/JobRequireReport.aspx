<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobRequireReport.aspx.cs" Inherits="HtmlPages_eva_customers" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" Height="442px"
