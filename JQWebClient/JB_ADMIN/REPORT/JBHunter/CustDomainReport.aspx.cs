    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {                
                ...
                ReportViewer1.LocalReport.DisplayName = CustName + "Domain";

                string ReportPath = "JB_ADMIN/REPORT/JBHunter/CustDomainReport.rdlc";//報表路徑
                var parameters = new List<object>();
                parameters.Add(CustID);

                this.ReportViewer1.LocalReport.ReportPath = ReportPath;
                this.ReportViewer1.LocalReport.DataSources.Clear();

                var obj = client.CallMethod(EFClientTools.ClientUtility.ClientInfo, "sCustomersJobs", "procReportCustDomain", parameters);
                ...
                this.ReportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("HUT_CustDomain", dt));
