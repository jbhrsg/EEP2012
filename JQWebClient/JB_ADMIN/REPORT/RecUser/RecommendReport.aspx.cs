...
public partial class HtmlPages_eva_customers : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (this.ClientQueryString != "")
        {
            ...
            var obj = client.CallMethod(EFClientTools.ClientUtility.ClientInfo, "_HRM_REC_User_Management", "procReportRecommendResume", parameters);
            ...
            var obj2 = client.CallMethod(EFClientTools.ClientUtility.ClientInfo, "_HRM_REC_User_Management", "procReportRecommendResume", parameters2);
