    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {                
                ...
                string ReportPath = "JB_ADMIN/REPORT/DelayLunch/BankRemit.rdlc";//報表路徑

                var parameters = new List<object>();
                parameters.Add(YearMonth + "," + ExportDate );
                var obj = client.CallMethod(EFClientTools.ClientUtility.ClientInfo, "sERPDelayLunchQuery", "ReportDelayLunch", parameters);
