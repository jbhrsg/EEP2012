    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {                
                ...
                string ReportPath = "";
                if (iType == "0")//0轉帳傳票  1傳票清單 2日記帳 3分類帳  4分類帳-不分頁 5分類帳-不分群組 6總分類帳-明細式 7總分類帳-統製式
                {
                    sDate = JQDate1;
                    ReportPath = "JB_ADMIN/REPORT/JBGL/glVoucherData.rdlc";//報表路徑
                }
                else if (iType == "1")//0轉帳傳票  1傳票清單 2日記帳 3分類帳  4分類帳-不分頁  5分類帳-不分群組 6總分類帳-明細式 7總分類帳-統製式                
                {
                ...
                {
                    ReportPath = "JB_ADMIN/REPORT/JBGL/ClassBills2.rdlc";//報表路徑
                }
                else if (iType == "5")
                {
                    ReportPath = "JB_ADMIN/REPORT/JBGL/ClassBills3.rdlc";//報表路徑
                }
                else if (iType == "6")
                {
                    ReportPath = "JB_ADMIN/REPORT/JBGL/ClassBills4.rdlc";//報表路徑
                }
                else if (iType == "7")
                {
                    ReportPath = "JB_ADMIN/REPORT/JBGL/ClassBills5.rdlc";//報表路徑
                }
