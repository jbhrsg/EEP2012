    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {                
                ...
                if (OrderType == "1")
                {
                    ReportPath = "JB_ADMIN/REPORT/FWCRM/FWCRMOrders.rdlc";//報表路徑
                }
                ...
                var obj = client.CallMethod(EFClientTools.ClientUtility.ClientInfo, "sFWCRMOrders", "ReportOrders", parameters);
