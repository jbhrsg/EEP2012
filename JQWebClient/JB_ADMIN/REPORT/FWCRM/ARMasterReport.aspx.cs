    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {                
                ...
                string ResidenceID = Request.QueryString["ResidenceID"];

                string ReportPath = "JB_ADMIN/REPORT/FWCRM/ARMasterReport.rdlc";//報表路徑

                var parameters = new List<object>();
                parameters.Add(ResidenceID);
                var obj = client.CallMethod(EFClientTools.ClientUtility.ClientInfo, "sFWCRMARMaster", "procReportARMaster", parameters);
