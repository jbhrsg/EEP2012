    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {                
                ...
                string IndateNo = Request.QueryString["IndateNo"];

                string ReportPath = "JB_ADMIN/REPORT/FWCRM/IndateNoReport.rdlc";//報表路徑

                var parameters = new List<object>();
                parameters.Add(IndateNo);
                var obj = client.CallMethod(EFClientTools.ClientUtility.ClientInfo, "sFWCRMGetNo", "ReportIndateNo", parameters);
