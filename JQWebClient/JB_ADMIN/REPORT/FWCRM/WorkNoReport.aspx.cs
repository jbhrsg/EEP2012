    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {                
                ...
                string ReportPath = "JB_ADMIN/REPORT/FWCRM/WorkNoReport.rdlc";//報表路徑

                var parameters = new List<object>();
                parameters.Add(WorkNo);
                var obj = client.CallMethod(EFClientTools.ClientUtility.ClientInfo, "sFWCRMGetNo", "ReportWorkNo", parameters);
