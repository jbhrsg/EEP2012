    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {                
                ...
                string ReportPath = "JB_ADMIN/REPORT/JCS1/BillData.rdlc";//報表路徑

                var parameters = new List<object>();
                parameters.Add(YM + "," + CustID );
                var obj = client.CallMethod(EFClientTools.ClientUtility.ClientInfo, "sJCS1", "procReportJCS1BillData", parameters);
