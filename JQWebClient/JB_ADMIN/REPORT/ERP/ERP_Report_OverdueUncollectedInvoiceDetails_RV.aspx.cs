    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {                
                ...
                string ReportPath = "";
                ReportPath = "JB_ADMIN/REPORT/ERP/ERP_Report_OverdueUncollectedInvoiceDetails.rdlc";

                var parameters = new List<object>();
                parameters.Add(InsGroupID + "," + SalesTypeID + "," + SalesID + "," + CustomerID + "," + ARDate);
                //回json string
                var obj = client.CallMethod(EFClientTools.ClientUtility.ClientInfo, "sERP_Report_OverdueUncollectedInvoiceDetails", "GetReportData", parameters);
