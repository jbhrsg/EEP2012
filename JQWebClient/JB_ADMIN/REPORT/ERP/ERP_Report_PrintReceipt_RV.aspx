<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ERP_Report_PrintReceipt_RV.aspx.cs" Inherits="MyPage_Customers" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="810px"
                 Font-Names="Verdana" Font-Size="8pt"
                InteractiveDeviceInfos="(Collection)" WaitMessageFont-Names="Verdana"
                WaitMessageFont-Size="14pt" Height="530px"><%--此為.NET 元件--%>
