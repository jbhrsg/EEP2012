    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {                
                ...
                string ReportPath = "";
                if(ReportType=="1")
                    ReportPath = "JB_ADMIN/REPORT/ERP/ERP_Report_BadOthAmountWarrantDetails_Bad.rdlc";
                else if (ReportType == "2")
                    ReportPath = "JB_ADMIN/REPORT/ERP/ERP_Report_BadOthAmountWarrantDetails_Oth.rdlc";

                var parameters = new List<object>();
                parameters.Add(CustomerID + "," + WarrantDateFrom + "," + WarrantDateTo + "," + ReportType + "," + InsGroupID);
                //回json string
                var obj = client.CallMethod(EFClientTools.ClientUtility.ClientInfo, "sERP_Report_BadOthAmountWarrantDetails", "GetReportData", parameters);
