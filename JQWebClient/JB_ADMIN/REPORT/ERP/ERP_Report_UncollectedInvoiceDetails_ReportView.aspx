<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ERP_Report_UncollectedInvoiceDetails_ReportView.aspx.cs" Inherits="HtmlPages_eva_customers" %>
...
<body>
    <form id="form1" runat="server">
        <div style="word-break:break-all;">
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="97%" Height="630px"
