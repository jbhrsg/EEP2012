<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JBTRAN_JBClassStudentnewjbclass.aspx.cs" Inherits="Template_JQuerySingle1" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sJBCourseQuery.JBClassStudentnewjbclass" runat="server" AutoApply="True"
                ...
                Title="" QueryMode="Fuzzy" Width="1280px" PageSize="20" AlwaysClose="True">
                <Columns>
