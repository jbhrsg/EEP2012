<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HRM_AttendOverTime.aspx.cs" Inherits="Template_JQuerySingle1" %>
         ...
         $(document).ready(function () {
             ...
             $("#dataGridDetail").datagrid({
                 onAfterEdit: function (rowIndex, rowData, changes) {
                     rowData.TotalHours = rowData.OverTimeHours + rowData.RestHours;
            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="加班單" DialogLeft="50px" DialogTop="30px">
                ...
                <JQTools:JQDataGrid ID="dataGridDetail" runat="server" AutoApply="False" DataMember="HRMAttendOverTimeApplyDetails" EditDialogID="JQDialog2" Pagination="False" ParentObjectID="dataFormMaster" RemoteName="sHRMAttendOverTime.HRMAttendOverTimeApplyMaster" Title="加班紀錄" AllowAdd="True" AllowDelete="True" AllowUpdate="True" AlwaysClose="False" BufferView="False" CheckOnSelect="True" ColumnsHibeable="False" DeleteCommandVisible="True" DuplicateCheck="False" EditMode="Dialog" EditOnEnter="True" InsertCommandVisible="True" MultiSelect="False" NotInitGrid="False" PageList="10,20,30,40,50" PageSize="10" QueryAutoColumn="False" QueryLeft="" QueryMode="Window" QueryTitle="Query" QueryTop="" RecordLock="False" RecordLockMode="None" TotalCaption="Total:" UpdateCommandVisible="True" ViewCommandVisible="True" >
                    ...
                    <Columns>
                        ...
                        <JQTools:JQGridColumn Alignment="right" Caption="加班時數" Editor="numberbox" FieldName="OverTimeHours" Format="" Width="52" />
                        <JQTools:JQGridColumn Alignment="right" Caption="補休時數" Editor="numberbox" FieldName="RestHours" Format="" Width="52" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" />
                        ...
                        <JQTools:JQGridColumn Alignment="left" Caption="加班原因" Editor="infocombobox" FieldName="OverTimeCauseID" Format="" Width="140" EditorOptions="valueField:'OVERTIME_CAUSE_ID',textField:'OVERTIME_CAUSE_CNAME',remoteName:'_HRM_Attend_Share.HRM_ATTEND_OVERTIME_CAUSE',tableName:'HRM_ATTEND_OVERTIME_CAUSE',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" />
                ...
                <JQTools:JQDialog ID="JQDialog2" runat="server" BindingObjectID="dataFormDetail" Title="新增加班資料">
                    <JQTools:JQDataForm ID="dataFormDetail" runat="server" ParentObjectID="dataFormMaster" DataMember="HRMAttendOverTimeApplyDetails" HorizontalColumnsCount="2" RemoteName="sHRMAttendOverTime.HRMAttendOverTimeApplyMaster" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" OnApply="checkOvertimeData" >
                        <Columns>
                            ...
                            <JQTools:JQFormColumn Alignment="left" Caption="加班原因" Editor="inforefval" FieldName="OverTimeCauseID" Format="" Width="180" EditorOptions="title:'加班原因',panelWidth:350,remoteName:'_HRM_Attend_Share.HRM_ATTEND_OVERTIME_CAUSE',tableName:'HRM_ATTEND_OVERTIME_CAUSE',columns:[{field:'OVERTIME_CAUSE_CODE',title:'加班原因代碼',width:100,align:'left',table:'',isNvarChar:false,queryCondition:''},{field:'OVERTIME_CAUSE_CNAME',title:'加班原因中文',width:230,align:'left',table:'',isNvarChar:false,queryCondition:''}],columnMatches:[{field:'OVERTIME_CAUSE_ID',value:'OVERTIME_CAUSE_ID'}],whereItems:[],valueField:'OVERTIME_CAUSE_CODE',textField:'OVERTIME_CAUSE_CNAME',valueFieldCaption:'加班原因代碼',textFieldCaption:'加班原因中文',cacheRelationText:true,checkData:true,showValueAndText:false,dialogCenter:false,selectOnly:false,capsLock:'none'" maxlength="0" />
                ...
                <JQTools:JQDefault ID="defaultMaster" runat="server" BindingObjectID="dataFormMaster" EnableTheming="True">
                    <Columns>
                        ...
                        <JQTools:JQDefaultColumn CarryOn="False" DefaultValue="_username" FieldName="OverTimeNO" RemoteMethod="True" />
                    </Columns>
                </JQTools:JQDefault>
                ...
                <JQTools:JQValidate ID="validateDetail" runat="server" BindingObjectID="dataFormDetail" EnableTheming="True">
                    <Columns>
                        <JQTools:JQValidateColumn CheckNull="True" FieldName="OverTimeDate" RemoteMethod="True" ValidateMessage="請選擇加班日期" ValidateType="None" />
