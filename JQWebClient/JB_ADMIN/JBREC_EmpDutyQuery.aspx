<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JBREC_EmpDutyQuery.aspx.cs" Inherits="Template_JQuerySingle1" %>
    ...
    <title></title>
     <script>
         ...
         var GetSalaryItem = function (SYearMonth, EYearMonth) {
             var CodeList = GetDataFromMethod('GetDutyID', { SYearMonth: SYearMonth, EYearMonth: EYearMonth });
         ...
         var GetSalaryItem_Period = function (SYearMonth, EYearMonth, CustomerID) {
             var CodeList = GetDataFromMethod('GetDutyID_Period', { SYearMonth: SYearMonth , EYearMonth: EYearMonth, CustomerID: CustomerID });
             if (CodeList != null) $("#SaryID_Query").combobox('loadData', CodeList);
         }
         ...
         function QSaryIDOnSelect() {
             ...
             if (QSaryID == '0000') {
                 ...
                 $.ajax({
                     type: "POST",
                     url: '../handler/jqDataHandle.ashx?RemoteName=sJBRecruitEmpSalary',
                     data: "mode=method&method=" + "GetDutyID_Select" + "&parameters=" + SYearMonth + "," + EYearMonth + "," + CustomerID,
                     cache: false,
                     async: false,
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sJBRecruitEmpSalary.View_EmployeeSalary" runat="server" AutoApply="False"
                DataMember="View_EmployeeSalary" Pagination="True" QueryTitle="派遣員工差勤查詢" EditDialogID="JQDialog1"
                ...
                <Columns>
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="差勤名稱" Editor="text" FieldName="SaryName" Format="" MaxLength="0" Visible="true" Width="120" />
                    <JQTools:JQGridColumn Alignment="right" Caption="數量小時" Editor="numberbox" FieldName="DutyQty" Format="N1" Visible="true" Width="90" Total="" />
                ...
                <QueryColumns>
                    <JQTools:JQQueryColumn AndOr="and" Caption="起始差勤年月" Condition="&gt;=" DataType="string" Editor="infocombobox" EditorOptions="valueField:'YearMonth',textField:'YearMonth',remoteName:'sJBRecruitEmpSalary.YearMonth',tableName:'YearMonth',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,onSelect:YearMonthOnSelect,panelHeight:200" FieldName="YearMonthS" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="90" />
                    <JQTools:JQQueryColumn AndOr="and" Caption="終止差勤年月" Condition="&lt;=" DataType="string" Editor="infocombobox" EditorOptions="valueField:'YearMonth',textField:'YearMonth',remoteName:'sJBRecruitEmpSalary.YearMonth',tableName:'YearMonth',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,onSelect:YearMonth1OnSelect,panelHeight:200" FieldName="YearMonthE" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="90" />
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="差勤項目" Condition="=" DataType="string" Editor="infocombobox" EditorOptions="items:[{value:'',text:'',selected:'false'}],checkData:false,selectOnly:false,cacheRelationText:false,onSelect:QSaryIDOnSelect,panelHeight:200" FieldName="SaryID" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="140" />
                    <JQTools:JQQueryColumn AndOr="and" Caption="差勤數量大於" Condition="&gt;" DataType="number" DefaultValue="0" Editor="text" FieldName="DutyQty" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
                </QueryColumns>
            </JQTools:JQDataGrid>
            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="派遣員工薪資查詢">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="View_EmployeeSalary" HorizontalColumnsCount="2" RemoteName="sJBRecruitEmpSalary.View_EmployeeSalary" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" >
                    <Columns>
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="差勤名稱" Editor="text" FieldName="DutyName" Format="" maxlength="0" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="差勤" Editor="numberbox" FieldName="DutyQty" Format="N" Width="180" />
                    </Columns>
                </JQTools:JQDataForm>
            ...
            <JQTools:JQDataGrid ID="JQDataGrid1" runat="server" AllowAdd="False" AllowDelete="False" AllowUpdate="False" AlwaysClose="False" AutoApply="True" BufferView="False" CheckOnSelect="False" ColumnsHibeable="False" DataMember="DutyItem" DeleteCommandVisible="False" DuplicateCheck="False" EditMode="Dialog" EditOnEnter="False" InsertCommandVisible="False" MultiSelect="True" NotInitGrid="False" PageList="25,50,75,100" PageSize="25" Pagination="False" QueryAutoColumn="False" QueryLeft="" QueryMode="Window" QueryTitle="Query" QueryTop="" RecordLock="False" RecordLockMode="None" RemoteName="sJBRecruitEmpSalary.DutyItem" RowNumbers="True" Title="選擇薪資項目" TotalCaption="Total:" UpdateCommandVisible="False" ViewCommandVisible="False" Width="360px">
                <Columns>
                    <JQTools:JQGridColumn Alignment="left" Caption="差勤代號" Editor="text" FieldName="SaryID" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="70">
                    </JQTools:JQGridColumn>
                    <JQTools:JQGridColumn Alignment="left" Caption="差勤名稱" Editor="text" FieldName="DutyName" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="240">
                    </JQTools:JQGridColumn>
                </Columns>
            </JQTools:JQDataGrid>
            </JQTools:JQDialog>
