        ...
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sERP_Setting_SalesKindSalesType.SalesKind" runat="server" AutoApply="True"
                ...
                <Columns>
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="對應人脈群組" Editor="text" FieldName="ConCenterNames" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="180">
                    </JQTools:JQGridColumn>
            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="銷貨主類別">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="SalesKind" HorizontalColumnsCount="1" RemoteName="sERP_Setting_SalesKindSalesType.SalesKind" DuplicateCheck="True" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" OnLoadSuccess="dataFormMasterOnLoadSuccess" OnApplied="dataFormMasterOnApplied" >
                    <Columns>
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="主類代號" Editor="text" FieldName="SalesKindID" Format="" Width="60" />
                        <JQTools:JQFormColumn Alignment="left" Caption="主類別名稱" Editor="text" FieldName="SalesKindName" Format="" maxlength="0" Width="180" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="人脈群組代號" Editor="text" FieldName="CENTER_IDS" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="320" />
            ...
            <JQTools:JQDataGrid ID="dataGrid1" runat="server" AllowAdd="True" AllowDelete="True" AllowUpdate="True" AlwaysClose="True" AutoApply="True" BufferView="False" CheckOnSelect="True" ColumnsHibeable="False" DataMember="SalesKindSalesType" DeleteCommandVisible="True" DuplicateCheck="True" EditMode="Dialog" EditOnEnter="False" InsertCommandVisible="True" MultiSelect="False" NotInitGrid="False" PageList="10,20,30,40,50" PageSize="10" Pagination="True" QueryAutoColumn="False" QueryLeft="" QueryMode="Window" QueryTitle="Query" QueryTop="" RecordLock="False" RecordLockMode="None" RemoteName="sERP_Setting_SalesKindSalesType.SalesKindSalesType" RowNumbers="True" Title="銷貨主類別銷貨類別" TotalCaption="Total:" UpdateCommandVisible="False" ViewCommandVisible="False" EditDialogID="JQDialog2">
                <Columns>
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="SalesKindID" Editor="text" FieldName="SalesKindID" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="False" Width="180">
                    </JQTools:JQGridColumn>
                    <JQTools:JQGridColumn Alignment="left" Caption="銷貨主類別" Editor="text" FieldName="SalesKindName" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="False" Width="120">
                    </JQTools:JQGridColumn>
                    <JQTools:JQGridColumn Alignment="left" Caption="SalesTypeID" Editor="text" FieldName="SalesTypeID" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="False" Width="90">
                    </JQTools:JQGridColumn>
                    <JQTools:JQGridColumn Alignment="left" Caption="銷貨類別" Editor="text" FieldName="SalesTypeName" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="180">
                    </JQTools:JQGridColumn>
            ...
            <JQTools:JQDialog ID="JQDialog2" runat="server" BindingObjectID="dataForm1" Title="銷貨主類別銷貨類別">
