<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JBFwcrm_CustomersJS.aspx.cs" Inherits="Template_JQuerySingle1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sFwcrmCustomer.EmployerJS" runat="server" AutoApply="True"
                DataMember="EmployerJS" Pagination="True" QueryTitle="" EditDialogID="JQDialog1"
                Title="傑信外勞雇主維護" QueryMode="Panel" AllowAdd="True" AllowDelete="True" AllowUpdate="True" AlwaysClose="False" BufferView="False" CheckOnSelect="True" ColumnsHibeable="False" DeleteCommandVisible="False" DuplicateCheck="False" EditMode="Dialog" EditOnEnter="True" InsertCommandVisible="True" MultiSelect="False" NotInitGrid="False" PageList="10,20,30,40,50" PageSize="10" QueryAutoColumn="False" QueryLeft="" QueryTop="" RecordLock="False" RecordLockMode="None" RowNumbers="True" TotalCaption="Total:" UpdateCommandVisible="True" ViewCommandVisible="False">
                <Columns>
            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="外勞雇主維護" DialogLeft="10px" DialogTop="10px" Width="1050px">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="EmployerJS" HorizontalColumnsCount="7" RemoteName="sFwcrmCustomer.EmployerJS" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" OnApplied="OnAppliedCus" >
                    <Columns>
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="公司傳真" Editor="text" FieldName="ContactFax" Format="" maxlength="0" Width="100" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="預計發薪日" Editor="infocombobox" EditorOptions="valueField:'ListID',textField:'ListContent',remoteName:'sFwcrmCustomer.infoSalaryDateJS',tableName:'infoSalaryDateJS',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,panelHeight:200" FieldName="SalaryDate" Format="" Width="80" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="雇主負擔" Editor="infooptions" EditorOptions="title:'請選擇',panelWidth:435,remoteName:'sFwcrmCustomer.infoFeeJS',tableName:'infoFeeJS',valueField:'ID',textField:'Name',columnCount:3,multiSelect:true,openDialog:false,selectAll:false,selectOnly:false,items:[]" FieldName="EmployerFee" MaxLength="0" NewRow="True" ReadOnly="False" RowSpan="1" Span="3" Visible="True" Width="370" />
                        <JQTools:JQFormColumn Alignment="left" Caption="雇主代扣" Editor="infooptions" EditorOptions="title:'請選擇',panelWidth:435,remoteName:'sFwcrmCustomer.infoFeeJS',tableName:'infoFeeJS',valueField:'ID',textField:'Name',columnCount:3,multiSelect:true,openDialog:false,selectAll:false,selectOnly:false,items:[]" FieldName="EmployerFee2" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="4" Visible="True" Width="370" />
