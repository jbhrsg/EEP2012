<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JCS_RoomerInOutQueryNew.aspx.cs" Inherits="Template_JQuerySingle1" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
         ...
         function dataGridMasterOnLoadSucess() {
             ...
             //if (rows.length <=0) {
             //    alert('提示:' + CurrentDate + '無逾時或刷卡異常資料');
             //    return;
             //}
         }
        ...
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="sJCSOutQuery.RoomerInOutQuery" runat="server" AutoApply="True"
                ...
                <Columns>
                    ...
                    <JQTools:JQGridColumn Alignment="center" Caption="最後刷出時間" Editor="text" FieldName="CardTimeLastOut" Format="" MaxLength="0" Width="110" Sortable="True" />
                    <JQTools:JQGridColumn Alignment="center" Caption="最後刷進時間" Editor="text" FieldName="CardTimeLastIn" Format="" MaxLength="0" Width="110" Sortable="True" />
                    ...
                    <JQTools:JQGridColumn Alignment="right" Caption="外出時數" Editor="numberbox" FieldName="HoursLastOut" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="65">
                    ...
                    <JQTools:JQGridColumn Alignment="center" Caption="刷卡異常" Editor="checkbox" EditorOptions="on:1,off:0" FieldName="IsErrHint" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="80" FormatScript="genCheckBox">
                    </JQTools:JQGridColumn>
                </Columns>
                <TooItems>
