<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JBCON_CONCENTER.aspx.cs" Inherits="Template_JQuerySingle1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sCON_CENTER.CON_CENTER" runat="server" AutoApply="True"
                DataMember="CON_CENTER" Pagination="True" QueryTitle="Query" EditDialogID="JQDialog1"
                Title="人脈群組設定" AllowAdd="True" AllowDelete="True" AllowUpdate="True" AlwaysClose="False" BufferView="False" CheckOnSelect="True" ColumnsHibeable="False" DeleteCommandVisible="True" DuplicateCheck="False" EditMode="Dialog" EditOnEnter="True" InsertCommandVisible="True" MultiSelect="False" NotInitGrid="False" PageList="10,20,30,40,50" PageSize="10" QueryAutoColumn="False" QueryLeft="" QueryMode="Window" QueryTop="" RecordLock="False" RecordLockMode="None" RowNumbers="True" TotalCaption="Total:" UpdateCommandVisible="True" ViewCommandVisible="True" Width="840px" OnSelect="dataGridViewOnSelect">
                <Columns>
                    <JQTools:JQGridColumn Alignment="center" Caption="群組代號" Editor="numberbox" FieldName="CENTER_ID" Format="" Visible="True" Width="60" />
                    <JQTools:JQGridColumn Alignment="left" Caption="群組中文名稱" Editor="text" FieldName="CENTER_CNAME" Format="" MaxLength="0" Visible="true" Width="180" />
                    <JQTools:JQGridColumn Alignment="left" Caption="群組英文名稱" Editor="text" FieldName="CENTER_ENAME" Format="" MaxLength="0" Visible="true" Width="180" />
                    <JQTools:JQGridColumn Alignment="right" Caption="排序" Editor="numberbox" FieldName="CENTER_SEQ" Format="" Visible="true" Width="40" />
                    <JQTools:JQGridColumn Alignment="left" Caption="建檔人員" Editor="text" FieldName="CREATE_MAN" Format="" MaxLength="0" Visible="true" Width="120" />
                    <JQTools:JQGridColumn Alignment="left" Caption="建檔日期" Editor="datebox" FieldName="CREATE_DATE" Format="yyyy/mm/dd HH:MM:SS" Visible="true" Width="120" />
            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="人脈群組設定" DialogLeft="30px" DialogTop="50px">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="CON_CENTER" HorizontalColumnsCount="2" RemoteName="sCON_CENTER.CON_CENTER" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" >
                    <Columns>
                        <JQTools:JQFormColumn Alignment="left" Caption="群組代號" Editor="numberbox" FieldName="CENTER_ID" Format="" Width="60" ReadOnly="True" Span="2" />
                        <JQTools:JQFormColumn Alignment="left" Caption="中文名稱" Editor="text" FieldName="CENTER_CNAME" Format="" maxlength="0" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="英文名稱" Editor="text" FieldName="CENTER_ENAME" Format="" maxlength="0" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="排序" Editor="numberbox" FieldName="CENTER_SEQ" Format="" Width="60" />
            ...
            <br />
            <JQTools:JQDataGrid ID="JQDataGrid1" runat="server" AllowAdd="True" AllowDelete="True" AllowUpdate="True" AlwaysClose="True" AutoApply="True" BufferView="False" CheckOnSelect="True" ColumnsHibeable="False" DataMember="CON_CENTER_AUTHORITY" DeleteCommandVisible="True" DuplicateCheck="False" EditMode="Dialog" EditOnEnter="True" InsertCommandVisible="True" MultiSelect="False" NotInitGrid="False" PageList="10,20,30,40,50" PageSize="10" Pagination="True" QueryAutoColumn="False" QueryLeft="" QueryMode="Window" QueryTitle="Query" QueryTop="" RecordLock="False" RecordLockMode="None" RemoteName="sCON_CENTER.CON_CENTER_AUTHORITY" RowNumbers="True" Title="群組使用者" TotalCaption="Total:"  UpdateCommandVisible="True" ViewCommandVisible="True" Width="840px" EditDialogID="JQDialog2">
                <Columns>
                    ...
                    <JQTools:JQGridColumn Alignment="center" Caption="業務人員" Editor="checkbox" FieldName="ISSALES" FormatScript="genCheckBox" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="80">
                    </JQTools:JQGridColumn>
                    <JQTools:JQGridColumn Alignment="left" Caption="建立人員" Editor="text" FieldName="CREATE_MAN" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="120">
                    </JQTools:JQGridColumn>
            ...
            <JQTools:JQDialog ID="JQDialog2" runat="server" BindingObjectID="JQDataForm1" Title="群組使用者" Width="600px">
                <JQTools:JQDataForm ID="JQDataForm1" runat="server" DataMember="CON_CENTER_AUTHORITY" HorizontalColumnsCount="1" RemoteName="sCON_CENTER.CON_CENTER_AUTHORITY" Closed="False" ContinueAdd="False" disapply="False" DuplicateCheck="False" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" AlwaysReadOnly="False" DivFramed="False" HorizontalGap="0" VerticalGap="0">
                    <Columns>
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="使用者" Editor="infocombobox" FieldName="USERID" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="120" EditorOptions="valueField:'USERID',textField:'USERNAME',remoteName:'sCON_CENTER.USERS',tableName:'USERS',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,onSelect:SetUserName,panelHeight:200" OnBlur="GetUserName" />
                        <JQTools:JQFormColumn Alignment="left" Caption="業務人員" Editor="checkbox" EditorOptions="on:1,off:0" FieldName="ISSALES" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="80" />
