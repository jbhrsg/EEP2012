    ...
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sERPCustomer.ERPCustomers" runat="server" AutoApply="True"
                ...
                Title="客戶維護" AllowAdd="True" AllowDelete="True" AllowUpdate="True" AlwaysClose="True" CheckOnSelect="True" ColumnsHibeable="False" DeleteCommandVisible="False" DuplicateCheck="False" EditMode="Dialog" EditOnEnter="True" InsertCommandVisible="True" MultiSelect="False" PageList="10,20,30,40,50" PageSize="10" QueryAutoColumn="False" QueryLeft="" QueryMode="Panel" QueryTop="" RecordLock="False" RecordLockMode="None" TotalCaption="Total:" UpdateCommandVisible="True" ViewCommandVisible="False" ParentObjectID="" OnSelect="SetWhereGridView" OnDelete="dataGridViewOnDelete" OnLoadSuccess="dataGridViewLoadSucess" BufferView="False" NotInitGrid="False" RowNumbers="True">
                <Columns>
                    <JQTools:JQGridColumn Alignment="left" Caption="客戶代號" Editor="text" FieldName="CustNO" Format="" MaxLength="0" Width="80" Frozen="True" />
                    <JQTools:JQGridColumn Alignment="left" Caption="客戶簡稱" Editor="text" FieldName="CustShortName" Format="" MaxLength="0" Width="95" Frozen="True" />
                    <JQTools:JQGridColumn Alignment="left" Caption="客戶統編" Editor="text" FieldName="TaxNO" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="75">
                ...
                <QueryColumns>
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="客戶名稱(簡稱)" Condition="%%" DataType="string" Editor="text" FieldName="CustName" IsNvarChar="False" NewLine="False" RemoteMethod="False" Width="100" />
                    <JQTools:JQQueryColumn AndOr="and" Caption="統編" Condition="%" DataType="string" Editor="text" FieldName="TaxNO" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="90" />
            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="客戶維護" DialogLeft="10px" DialogTop="10px" EnableTheming="False" Width="1020px">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="ERPCustomers" HorizontalColumnsCount="7" RemoteName="sERPToDoCustomer.ERPCustomers" Closed="False" ContinueAdd="False" disapply="False" DuplicateCheck="False" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="True" IsRejectON="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" OnApplied="dataFormMasterOnApplied" ParentObjectID="dataGridView" OnLoadSuccess="dataFormMasterLoadSucess" AlwaysReadOnly="False" DivFramed="False" HorizontalGap="0" VerticalGap="0" OnApply="dataFormMasterOnApply" ChainDataFormID="dataFormMaster2" >
                    <Columns>
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="統一編號" Editor="text" FieldName="TaxNO" NewRow="False" Span="6" Width="90" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="CustPost" NewRow="False" Span="1" Width="40" MaxLength="0" ReadOnly="False" RowSpan="1" Visible="True" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="checkbox" EditorOptions="on:1,off:0" FieldName="IsAddLine" maxlength="0" NewRow="True" Span="1" Width="30" Visible="True" />
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="infocombobox" EditorOptions="valueField:'LetterTypeID',textField:'LetterTypeName',remoteName:'sERPCustomer.LetterType',tableName:'LetterType',pageSize:'-1',checkData:true,selectOnly:false,cacheRelationText:false,panelHeight:200" FieldName="LetterType" maxlength="0" Span="1" Width="140" NewRow="False" />
                        <JQTools:JQFormColumn Alignment="left" Caption="聯絡人1" Editor="text" FieldName="ContactA" Span="7" Width="90" NewRow="False" Format="" />
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContactASubTel" NewRow="False" Width="33" Format="" maxlength="0" />
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="checkbox" FieldName="samA" NewRow="False" Width="20" OnBlur="" />
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="infocombobox" FieldName="ContactAJobID" Format="" Width="83" NewRow="False" EditorOptions="valueField:'CustJobID',textField:'CustJobName',remoteName:'sERPCustomer.CustJob',tableName:'CustJob',pageSize:'-1',checkData:true,selectOnly:false,cacheRelationText:false,panelHeight:200" maxlength="0" Span="1" />
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContactATel" Format="" Width="90" NewRow="False" Span="1" ReadOnly="False" Visible="True" />
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContactAMail" Format="" Width="190" NewRow="False" Span="1" Visible="True" maxlength="0" />
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="checkbox" FieldName="ContactAIsMail" Format="" Width="30" NewRow="False" Span="1" Visible="True" ReadOnly="False" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContactBMail" Width="190" Format="" maxlength="0" ReadOnly="False" Visible="True" />
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="checkbox" FieldName="samB" Width="20" maxlength="0" Span="1" />
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContactBSubTel" Width="33" Format="" Span="1" NewRow="False" ReadOnly="False" Visible="True" />
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="infocombobox" FieldName="ContactBJobID" Format="" Width="83" Span="1" EditorOptions="valueField:'CustJobID',textField:'CustJobName',remoteName:'sERPCustomer.CustJob',tableName:'CustJob',pageSize:'-1',checkData:true,selectOnly:false,cacheRelationText:false,panelHeight:200" NewRow="False" MaxLength="0" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="checkbox" FieldName="ContactBIsMail" Format="" Width="30" NewRow="False" Span="1" MaxLength="0" ReadOnly="False" RowSpan="1" Visible="True" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="發票收到確認" Editor="checkbox" FieldName="bElecInvoice" Width="30" maxlength="0" Span="7" NewRow="True" ReadOnly="False" RowSpan="1" Visible="True" EditorOptions="on:1,off:0" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="BalanceDay" MaxLength="0" NewRow="True" Span="1" Width="33" Format="" ReadOnly="False" Visible="True" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="NotAcceptPaper" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="320" />
