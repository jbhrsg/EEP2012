<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form_SecurityDepositWarrant.aspx.cs" Inherits="Template_JQuerySingle1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sForm_SecurityDepositWarrant.SecurityDepositWarrant" runat="server" AutoApply="True"
                DataMember="SecurityDepositWarrant" Pagination="True" QueryTitle="Query" EditDialogID="JQDialog1"
                ...
                <Columns>
                    <JQTools:JQGridColumn Alignment="left" Caption="DepositWarrantNO" Editor="text" FieldName="DepositWarrantNO" Format="" MaxLength="0" Visible="true" Width="120" />
                    <JQTools:JQGridColumn Alignment="left" Caption="DepositNO" Editor="text" FieldName="DepositNO" Format="" MaxLength="0" Visible="true" Width="120" />
                    <JQTools:JQGridColumn Alignment="left" Caption="DepositProperty" Editor="text" FieldName="DepositProperty" Format="" MaxLength="0" Visible="true" Width="120" />
                    <JQTools:JQGridColumn Alignment="left" Caption="CusSupplier" Editor="text" FieldName="CusSupplier" Format="" MaxLength="0" Visible="true" Width="120" />
                    <JQTools:JQGridColumn Alignment="right" Caption="DepositAmount" Editor="numberbox" FieldName="DepositAmount" Format="" Visible="true" Width="120" />
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="Notes" Editor="text" FieldName="Notes" Format="" MaxLength="0" Visible="true" Width="120" />
                    <JQTools:JQGridColumn Alignment="left" Caption="InOutDate" Editor="datebox" FieldName="InOutDate" Format="" Visible="true" Width="120" />
                    <JQTools:JQGridColumn Alignment="left" Caption="InOutWay" Editor="text" FieldName="InOutWay" Format="" MaxLength="0" Visible="true" Width="120" />
                    <JQTools:JQGridColumn Alignment="left" Caption="CusSupplierAccName" Editor="text" FieldName="CusSupplierAccName" Format="" MaxLength="0" Visible="False" Width="120" />
                    <JQTools:JQGridColumn Alignment="left" Caption="VoucherNO" Editor="text" FieldName="VoucherNO" Format="" MaxLength="0" Visible="False" Width="120" />
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="RequisitionNO" Editor="text" FieldName="RequisitionNO" Format="" MaxLength="0" Visible="true" Width="120" />
            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="保證金沖銷單" Width="700px">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="SecurityDepositWarrant" HorizontalColumnsCount="2" RemoteName="sForm_SecurityDepositWarrant.SecurityDepositWarrant" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalGap="0" IsAutoPageClose="True" IsAutoPause="False" IsAutoSubmit="True" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="True" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" OnApply="OnApply_dataFormMaster" >
                    <Columns>
                        <JQTools:JQFormColumn Alignment="left" Caption="保證金沖銷單號" Editor="text" FieldName="DepositWarrantNO" Format="" maxlength="0" Width="180" ReadOnly="True" Visible="True" />
                        <JQTools:JQFormColumn Alignment="left" Caption="保證金單號" Editor="inforefval" FieldName="DepositNO" Format="" maxlength="0" Width="180" EditorOptions="title:'保證金單號',panelWidth:350,panelHeight:200,remoteName:'sForm_SecurityDepositWarrant.DepositNO',tableName:'DepositNO',columns:[{field:'DepositNO',title:'保證金單號',width:80,align:'left',table:'',isNvarChar:false,queryCondition:''},{field:'CusSupplier',title:'客戶供應商',width:80,align:'left',table:'',isNvarChar:false,queryCondition:''}],columnMatches:[],whereItems:[],valueField:'DepositNO',textField:'DepositNO',valueFieldCaption:'DepositNO',textFieldCaption:'DepositNO',cacheRelationText:false,checkData:false,showValueAndText:false,dialogCenter:false,onSelect:OnSelect_dataFormMasterDepositNO,selectOnly:true,capsLock:'none',fixTextbox:'false'" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="客戶供應商" Editor="inforefval" FieldName="CusSupplier" Format="" maxlength="0" Width="180" EditorOptions="title:'客戶供應商',panelWidth:600,remoteName:'sForm_SecurityDepositWarrant.VenderCustomer',tableName:'VenderCustomer',columns:[{field:'ID',title:'編號',width:100,align:'left',table:'',isNvarChar:false,queryCondition:''},{field:'Name',title:'名稱',width:100,align:'left',table:'',isNvarChar:false,queryCondition:''},{field:'Tel',title:'電話',width:100,align:'left',table:'',isNvarChar:false,queryCondition:''},{field:'Addr',title:'地址',width:180,align:'left',table:'',isNvarChar:false,queryCondition:''},{field:'EntityType',title:'類型',width:100,align:'left',table:'',isNvarChar:false,queryCondition:''}],columnMatches:[],whereItems:[],valueField:'ID',textField:'Name',valueFieldCaption:'名稱',textFieldCaption:'名稱',cacheRelationText:false,checkData:false,showValueAndText:false,dialogCenter:false,selectOnly:true,capsLock:'none',fixTextbox:'false'" />
                        <JQTools:JQFormColumn Alignment="left" Caption="保證金金額" Editor="numberbox" FieldName="DepositAmount" Format="" Width="180" ReadOnly="True" />
                        <JQTools:JQFormColumn Alignment="left" Caption="返還金額" Editor="numberbox" FieldName="WarrantAmount" Format="" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="未返還金額" Editor="numberbox" FieldName="OtherWarrantAmount" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="180" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="請款單號" Editor="text" FieldName="RequisitionNO" Format="" maxlength="0" Width="100" ReadOnly="True" />
                        <JQTools:JQFormColumn Alignment="left" Caption="返還日期" Editor="datebox" FieldName="InOutDate" Format="" Width="180" />
                        <JQTools:JQFormColumn Alignment="left" Caption="收支方式" Editor="infocombobox" FieldName="InOutWay" Format="" maxlength="0" Width="180" EditorOptions="valueField:'InOutWayValue',textField:'InOutWayName',remoteName:'sForm_SecurityDepositWarrant.InOutWay',tableName:'InOutWay',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" />
