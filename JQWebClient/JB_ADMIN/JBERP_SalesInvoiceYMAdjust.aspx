...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        //選取查詢選項是否已匯入=>0未匯入,2不拘(2不拘時=>隱藏整批修改)
        ...
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="sSalesInvoiceYMAdjust.ERPSalesDetails" runat="server" AutoApply="True"
                ...
                <Columns>
                    ...
                    <JQTools:JQGridColumn Alignment="center" Caption="交易別" Editor="text" FieldName="SalesTypeName" Format="" MaxLength="0" Width="57" ReadOnly="True" />
                    <JQTools:JQGridColumn Alignment="center" Caption="銷貨日期" Editor="datebox" FieldName="SalesDate" Format="" Width="70" ReadOnly="True" />
                    <JQTools:JQGridColumn Alignment="center" Caption="發票年月" Editor="text" FieldName="InvoiceYM" Format="" MaxLength="0" Width="68" />
                    ...
                    <JQTools:JQGridColumn Alignment="right" Caption="客戶總價" Editor="text" FieldName="CustAmt" Format="" Width="60" ReadOnly="True" Sortable="True" />
                    ...
                    <JQTools:JQGridColumn Alignment="right" Caption="繳社總價" Editor="text" FieldName="OfficeAmt" MaxLength="0" Width="60" ReadOnly="True" Sortable="True" />
