        ...
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sFwcrmCustomer.EmployerJSCare" runat="server" AutoApply="True"
                ...
                <Columns>
                    ...
                    <JQTools:JQGridColumn Alignment="center" Caption="雇主名稱" Editor="text" FieldName="EmployerName" Format="" MaxLength="0" Visible="true" Width="80" />
                    ...
                    <JQTools:JQGridColumn Alignment="center" Caption="雇主編號" Editor="text" FieldName="EmployerNo" Format="" MaxLength="0" Visible="true" Width="110" />
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="雇主地址" Editor="text" FieldName="EmployerAddress" Format="" MaxLength="0" Visible="true" Width="283" />
