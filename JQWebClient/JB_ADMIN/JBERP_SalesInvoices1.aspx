<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JBERP_SalesInvoices1.aspx.cs" Inherits="Template_JQuerySingle1" %>
            ...
            for (var i = 0; i <= rows.length - 1; i++) {
                ...
                if (rows[i].QInvoiceType == '98' || rows[i].QInvoiceType == '99') {
                    if (rows[i].CreateInvoiceType != "2") {//電開
                        Rstr = CallAPI_Cancel(rows[i].InsGroupID, rows[i].SalesNO, rows[i].InvoiceNO, P_RentID, P_APIWebCode + P_APIPassword, ReturnTaxNumber, ReturnRemark);
                    ...
                    success: function (data) {
                        if (data != "False") {
                            ...
                            if (rows.length > 0) {
                                ...
                                $("#dataFormMasterTaxType").combobox('setValue', rows[0].TaxType);
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sERPSalesInvoices.SalesMaster" runat="server" AutoApply="True"
                ...
                <TooItems>
                    <JQTools:JQToolItem Icon="icon-add" ItemType="easyui-linkbutton"     OnClick="dataGridView_Add_OnClick" Text="新增銷貨" Visible="False" />
                    <JQTools:JQToolItem Icon="icon-upload" ItemType="easyui-linkbutton"  OnClick="CreateInvoice" Text="開立發票" Visible="False" />
                    <JQTools:JQToolItem Icon="icon-undo" ItemType="easyui-linkbutton"    OnClick="CancelInvoice" Text="作廢發票" Visible="False"/>
                    <JQTools:JQToolItem Icon="icon-upload" ItemType="easyui-linkbutton"  OnClick="SelectCreateReceipt" Text="開立收據" Visible="False" />
                    <JQTools:JQToolItem Icon="icon-undo" ItemType="easyui-linkbutton"    OnClick="CancelReceipt" Text="作廢收據" Visible="False"/>
                    <JQTools:JQToolItem Icon="icon-cut" ItemType="easyui-linkbutton"     OnClick="SelectDelete" Text="作廢銷貨" Visible="False" />
                    <JQTools:JQToolItem Enabled="True" ItemType="easyui-linkbutton" OnClick="BatchAdd_OnClick" Text="批次新增二聯(宿舍)" Visible="False" Icon="icon-add" />
                    <JQTools:JQToolItem Enabled="True" Icon="icon-excel" ItemType="easyui-linkbutton" OnClick="exportGrid" Text="匯出Excel" Visible="False" />
                </TooItems>
                <QueryColumns>
            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="銷貨資料維護" Width="880px" DialogLeft="0px" DialogTop="50px">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="SalesMaster" HorizontalColumnsCount="4" RemoteName="sERPSalesInvoices.SalesMaster" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" OnLoadSuccess="dataFormMasterOnLoadSuccess" OnApply="dataFormMasterOnApply" >
                    <Columns>
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="銷貨類別" Editor="infocombobox" EditorOptions="valueField:'SalesTypeID',textField:'SalesTypeName',remoteName:'sERPSalesInvoices.CustomerSaleType',tableName:'CustomerSaleType',pageSize:'-1',checkData:true,selectOnly:false,cacheRelationText:false,onSelect:SalesTypeID_OnSelect,panelHeight:200" FieldName="SalesTypeID" Format="" PlaceHolder="" ReadOnly="True" Visible="True" Width="120" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="備註(發票)" Editor="textarea" EditorOptions="height:18" FieldName="Remark" MaxLength="0" NewRow="False" ReadOnly="True" RowSpan="1" Span="4" Visible="True" Width="680" />
