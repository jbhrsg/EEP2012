<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HRM_REC_User_Management.aspx.cs" Inherits="Template_JQuerySingle1" %>
...
<head runat="server">
    ...
    <title></title>
      ...
      <script type="text/javascript">
          $(function () {
              $("#NameC_Query").attr("placeholder", "手機/姓名/身份(居留)證/履歷編號");
          ...
          $(document).ready(function () {
              ...
              //////--------------身高、體重、婚姻狀況...-----------------------------------------------------------------
              var IdentityID = $('#dataFormMaster2IdentityID').closest('td');
              var Tall = $('#dataFormMaster2Tall').closest('td').children();
              ...
              IdentityID.append("&nbsp;&nbsp;身高").append(Tall).append("&nbsp;&nbsp;體重").append(Weight).append("&nbsp;&nbsp;現居地").append(HouseOwnStatus).append("&nbsp;&nbsp;兵役狀況").append(MilitaryServiceIDs).append("&nbsp;&nbsp;免役原因").append(MilitaryReason).append("&nbsp;&nbsp;退伍年月").append(MilitaryYM);
              ...
              //加上(紫色)的欄位
              var HideFieldName = ['2PID', '2ResidentID', '2Birthday', 'CurTelNO', '2CONTACT_NAME', '2IdentityID'];
          ...
          function GoToShowList() {
              ...
              $.ajax({
                  type: "POST",
                  url: '../handler/jqDataHandle.ashx?RemoteName=_HRM_REC_User_Management.REC_User', //連接的Server端，command
          ...
          function OnApplyUser() {
              ...
              //國籍若為非台灣(1),則身分別不可選一般人士(1)
              var Country = $('#dataFormMasterCountry').combobox('getValue');//國籍
              var IdentityID = $('#dataFormMaster2IdentityID').combobox('getValue');//身分別
              if (Country!="1" && IdentityID=="1") {
                  alert('國籍若為非台灣籍,則身分別不可選一般人士！');
                  return false;
              }
              //if (Country == "1" && IdentityID != "1") {
              //    alert('國籍若為台灣籍,則身分別應選一般人士！');
              //    return false;
              //}
          ...
          function ReturnAssignLogsCount(iType, AutoKey) {
              ...
              $.ajax({
                  type: "POST",
                  url: '../handler/jqDataHandle.ashx?RemoteName=_HRM_REC_User_Management.REC_User',
          ...
          function OnDeleteRECUser(rowData) {
              ...
              if (pre == true) {
                  ...
                  $.ajax({
                      type: "POST",
                      url: '../handler/jqDataHandle.ashx?RemoteName=_HRM_REC_User_Management.REC_User',
                      data: "mode=method&method=" + "UpdateREC_User" + "&parameters=" + rowData.UserID,
                      cache: false,
                      async: true,
                  });
        ...
        ////
          ...
          function RecruitLink(value, row, index) {
              ...
              } else if (row.Country == "1" && (row.PID == "" || row.CurTelNO == "" || row.Birthday == null || row.IdentityID == null || row.IdentityID == "")) {//

                  return "<a style='color:red' title='身份證號、出生日期、聯絡電話、身份別必填。'>資料不足</a>";

              } else if (row.Country != "1" && (row.ResidentID == "" || row.CurTelNO == "" || row.Birthday == null || row.IdentityID == null || row.IdentityID == "")) {//

                  return "<a style='color:red' title='居留證號 、出生日期、聯絡電話、身份別必填。'>資料不足</a>";
              }
              else {
...
<%--            <asp:Label ID="Label1" runat="server" ForeColor="#6600FF" BackColor="#FFFF99" Font-Size="Medium"></asp:Label>--%>
            <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="_HRM_REC_User_Management.REC_User" runat="server" AutoApply="True"
...
<%--                       <JQTools:JQToolItem Icon="icon-add" ItemType="easyui-linkbutton" OnClick="insertItem" Text="新增人才履歷" />        --%>
                ...
                <QueryColumns>
                               <JQTools:JQQueryColumn AndOr="and" Caption="人才搜尋" Condition="%" DataType="string" Editor="text" FieldName="NameC" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="2" Width="195" DefaultValue="" />
                                ...
                                <JQTools:JQQueryColumn AndOr="and" Caption="最高學歷" Condition="%" DataType="string" Editor="infocombobox" FieldName="EduID" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="80" EditorOptions="valueField:'EduID',textField:'EduName',remoteName:'_HRM_REC_User_Management.infoREC_ZEduLevel',tableName:'infoREC_ZEduLevel',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,panelHeight:110" />
                                ...
                                <JQTools:JQQueryColumn AndOr="and" Caption="招募區域" Condition="%" DataType="string" Editor="infocombobox" EditorOptions="valueField:'ID',textField:'SalesTeamName',remoteName:'_HRM_REC_User_Management.infoREC_SalesTeam',tableName:'infoREC_SalesTeam',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,onSelect:SalesTeamOnSelectQ,panelHeight:90" FieldName="ServiceSalesTeam" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="0" Width="70" />
                                <JQTools:JQQueryColumn AndOr="and" Caption="招募人員" Condition="%" DataType="string" Editor="infocombobox" EditorOptions="valueField:'ID',textField:'ConsultantName',remoteName:'_HRM_REC_User_Management.infoServiceConsultants',tableName:'infoServiceConsultants',pageSize:'-1',checkData:true,selectOnly:false,cacheRelationText:false,panelHeight:150" FieldName="ServiceConsultants" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="100" />
                                ...
                                <JQTools:JQQueryColumn AndOr="and" Caption="推薦樁腳" Condition="%" DataType="string" Editor="infocombobox" EditorOptions="valueField:'MemberID',textField:'NameC',remoteName:'_HRM_REC_User_Management.infoPFMemberID',tableName:'infoPFMemberID',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:150" FieldName="PFMemberID" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="100" />                                
            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="履歷維護" DialogLeft="9px" DialogTop="1px" Width="1050px">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="REC_User" HorizontalColumnsCount="6" RemoteName="_HRM_REC_User_Management.REC_User" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Dialog" VerticalGap="0" ChainDataFormID="dataFormMaster2" OnApplied="DFOnApplied" OnLoadSuccess="DFLoadSuccess" OnApply="OnApplyUser" >
                    <Columns>
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="現居地址" Editor="infocombobox" FieldName="Addr_Country" Format="" maxlength="0" Width="80" EditorOptions="valueField:'Country',textField:'Country',remoteName:'_HRM_REC_User_Management.Country',tableName:'Country',pageSize:'-1',checkData:true,selectOnly:false,cacheRelationText:false,onSelect:Addr_Country_OnSelect,panelHeight:200" Span="3" NewRow="False" ReadOnly="False" Visible="True" />
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="infocombobox" FieldName="Addr_City" Format="" maxlength="0" Width="80" EditorOptions="valueField:'City',textField:'City',remoteName:'_HRM_REC_User_Management.City',tableName:'City',pageSize:'-1',checkData:true,selectOnly:false,cacheRelationText:false,onSelect:Addr_City_OnSelect,panelHeight:200" Span="1" NewRow="False" Visible="True" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="上班工具" Editor="infooptions" FieldName="TrafficIDs" Format="" maxlength="0" NewRow="False" Span="3" Visible="True" Width="180" EditorOptions="title:'上班工具',panelWidth:390,remoteName:'_HRM_REC_User_Management.infoREC_ZTraffic',tableName:'infoREC_ZTraffic',valueField:'ID',textField:'Contents',columnCount:6,multiSelect:true,openDialog:false,selectAll:false,onSelect:OnSelectTrafficIDs,selectOnly:false,items:[]" ReadOnly="False" RowSpan="1" />
                        <JQTools:JQFormColumn Alignment="left" Caption="履歷編號" Editor="text" FieldName="UserID" MaxLength="0" NewRow="False" ReadOnly="True" RowSpan="1" Span="1" Visible="True" Width="85" />
                        <JQTools:JQFormColumn Alignment="left" Caption="血型" Editor="infocombobox" EditorOptions="valueField:'ID',textField:'Contents',remoteName:'_HRM_REC_User_Management.infoREC_ZBloodType',tableName:'infoREC_ZBloodType',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,panelHeight:120" FieldName="BloodType" NewRow="False" Span="1" Visible="True" Width="71" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="最高學歷" Editor="infocombobox" FieldName="EduID1" MaxLength="0" Span="1" Width="110" NewRow="False" ReadOnly="False" Visible="True" RowSpan="1" EditorOptions="valueField:'EduID',textField:'EduName',remoteName:'_HRM_REC_User_Management.infoREC_ZEduLevel',tableName:'infoREC_ZEduLevel',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,onSelect:EduID1Select,panelHeight:120" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="次高學歷" Editor="infocombobox" FieldName="EduID2" MaxLength="0" Span="1" Width="110" NewRow="False" ReadOnly="False" RowSpan="1" Visible="True" EditorOptions="valueField:'EduID',textField:'EduName',remoteName:'_HRM_REC_User_Management.infoREC_ZEduLevel',tableName:'infoREC_ZEduLevel',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,onSelect:EduID2Select,panelHeight:120" />
                ...
                <JQTools:JQDataForm ID="dataFormMaster3" runat="server" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" DataMember="REC_User" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalColumnsCount="6" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" RemoteName="_HRM_REC_User_Management.REC_User" ShowApplyButton="False" ValidateStyle="Dialog" VerticalGap="0" OnApplied="DFOnApplied" ChainDataFormID="" OnLoadSuccess="DFLoadSuccess">
                    <Columns>
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="期望薪資" Editor="text" EditorOptions="" FieldName="ExpectedSalary" NewRow="False" Span="1" Visible="True" Width="140" />
                        <JQTools:JQFormColumn Alignment="left" Caption="專業證照" Editor="text" FieldName="ProLicenses" maxlength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="260" />


                        <JQTools:JQFormColumn Alignment="left" Caption="工作時間" Editor="infooptions" EditorOptions="title:'上班工具',panelWidth:210,remoteName:'_HRM_REC_User_Management.infoREC_ZDutyTimes',tableName:'infoREC_ZDutyTimes',valueField:'ID',textField:'Contents',columnCount:6,multiSelect:true,openDialog:false,selectAll:false,selectOnly:false,items:[]" FieldName="DutyTimesIDs" Format="" maxlength="0" NewRow="True" ReadOnly="False" RowSpan="1" Span="3" Visible="True" Width="90" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="加班意願" Editor="infooptions" EditorOptions="title:'加班意願',panelWidth:280,remoteName:'_HRM_REC_User_Management.infoREC_ZOverTimes',tableName:'infoREC_ZOverTimes',valueField:'ID',textField:'Contents',columnCount:6,multiSelect:true,openDialog:false,selectAll:false,onSelect:OnSelectOverTimesIDs,selectOnly:false,items:[]" FieldName="OverTimesIDs" Format="" maxlength="0" NewRow="True" ReadOnly="False" RowSpan="1" Span="3" Visible="True" Width="90" />
                        <JQTools:JQFormColumn Alignment="left" Caption="無塵衣" Editor="infooptions" EditorOptions="title:'無塵衣',panelWidth:425,remoteName:'_HRM_REC_User_Management.infoREC_ZCleanClothes',tableName:'infoREC_ZCleanClothes',valueField:'ID',textField:'Contents',columnCount:6,multiSelect:true,openDialog:false,selectAll:false,onSelect:OnSelectCleanClothes,selectOnly:false,items:[]" FieldName="CleanClothesIDs" Format="" maxlength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="3" Visible="True" Width="90" />
                        <JQTools:JQFormColumn Alignment="left" Caption="工作工具" Editor="infooptions" EditorOptions="title:'工作工具',panelWidth:310,remoteName:'_HRM_REC_User_Management.infoREC_ZDutyTools',tableName:'infoREC_ZDutyTools',valueField:'ID',textField:'Contents',columnCount:6,multiSelect:true,openDialog:false,selectAll:false,onSelect:OnSelectDutyTools,selectOnly:false,items:[]" FieldName="DutyToolsIDs" Format="" maxlength="0" NewRow="True" ReadOnly="False" RowSpan="1" Span="3" Visible="True" Width="90" />
                        <JQTools:JQFormColumn Alignment="left" Caption="工作型態" Editor="infooptions" EditorOptions="title:'工作型態',panelWidth:400,remoteName:'_HRM_REC_User_Management.infoREC_ZDutyActTypes',tableName:'infoREC_ZDutyActTypes',valueField:'ID',textField:'Contents',columnCount:6,multiSelect:true,openDialog:false,selectAll:false,onSelect:OnSelectDutyActTypesIDs,selectOnly:false,items:[]" FieldName="DutyActTypesIDs" Format="" maxlength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="3" Visible="True" Width="90" />
                        <JQTools:JQFormColumn Alignment="left" Caption="工作環境" Editor="infooptions" EditorOptions="title:'工作環境',panelWidth:400,remoteName:'_HRM_REC_User_Management.infoREC_ZDutyEnvironment',tableName:'infoREC_ZDutyEnvironment',valueField:'ID',textField:'Contents',columnCount:6,multiSelect:true,openDialog:false,selectAll:false,onSelect:OnSelectDutyEnvironmentIDs,selectOnly:false,items:[]" FieldName="DutyEnvironmentIDs" Format="" maxlength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="3" Visible="True" Width="90" />                        
                        <JQTools:JQFormColumn Alignment="left" Caption="工作縣市" Editor="infooptions" EditorOptions="title:'工作縣市',panelWidth:330,remoteName:'_HRM_REC_User_Management.infoREC_ZDutyAreasClass',tableName:'infoREC_ZDutyAreasClass',valueField:'ID',textField:'Contents',columnCount:3,multiSelect:true,openDialog:false,selectAll:false,onSelect:OnSelectDutyAreaClass,selectOnly:false,items:[]" FieldName="DutyAreaClassIDs" Format="" NewRow="True" Span="2" Visible="True" Width="90" MaxLength="0" ReadOnly="False" RowSpan="1" />
                        <JQTools:JQFormColumn Alignment="left" Caption="工作地點" Editor="infooptions" EditorOptions="title:'工作地點',panelWidth:570,remoteName:'_HRM_REC_User_Management.infoREC_ZDutyAreas',tableName:'infoREC_ZDutyAreas',valueField:'ID',textField:'Contents',columnCount:8,multiSelect:true,openDialog:false,selectAll:false,onWhere:OnWhereAreaClassID,selectOnly:false,items:[]" FieldName="DutyAreasIDs" Format="" NewRow="False" Span="4" Visible="True" Width="90" MaxLength="0" ReadOnly="False" RowSpan="1" />
                ...
                <JQTools:JQDataForm ID="dataFormMaster2" runat="server" AlwaysReadOnly="False" ChainDataFormID="dataFormMaster3" Closed="False" ContinueAdd="False" DataMember="REC_User" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalColumnsCount="7" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" OnApplied="DFOnApplied" RemoteName="_HRM_REC_User_Management.REC_User" ShowApplyButton="False" ValidateStyle="Dialog" VerticalGap="0">
                    <Columns>
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="infocombobox" FieldName="CONTACT_RELATION_ID" maxlength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="80" EditorOptions="valueField:'RELATION_ID',textField:'RELATION_NAME',remoteName:'_HRM_REC_User_Management.infoCONTACT_RELATION_ID',tableName:'infoCONTACT_RELATION_ID',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,panelHeight:90" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="infocombobox" FieldName="Domicile_Addr_Country" maxlength="0" NewRow="False" Span="1" Visible="True" Width="75" EditorOptions="valueField:'Country',textField:'Country',remoteName:'_HRM_REC_User_Management.Country',tableName:'Country',pageSize:'-1',checkData:true,selectOnly:false,cacheRelationText:false,onSelect:Domicile_Addr_Country_OnSelect,panelHeight:200" Format="" ReadOnly="False" RowSpan="1" />
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="infocombobox" EditorOptions="valueField:'City',textField:'City',remoteName:'_HRM_REC_User_Management.City',tableName:'City',pageSize:'-1',checkData:true,selectOnly:false,cacheRelationText:false,onSelect:Domicile_Addr_City_OnSelect,panelHeight:200" FieldName="Domicile_Addr_City" maxlength="0" NewRow="False" ReadOnly="False" Span="1" Visible="True" Width="75" Format="" RowSpan="1" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="身份別" Editor="infocombobox" FieldName="IdentityID" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="6" Visible="True" Width="90" EditorOptions="valueField:'EMPLOYEE_IDENTITY_ID',textField:'EMPLOYEE_IDENTITY_CNAME',remoteName:'_HRM_REC_User_Management.infoHRM_EMPLOYEE_IDENTITY',tableName:'infoHRM_EMPLOYEE_IDENTITY',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:150" Format="" />
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="numberbox" FieldName="Tall" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="40" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="infocombobox" EditorOptions="valueField:'ID',textField:'Contents',remoteName:'_HRM_REC_User_Management.infoREC_ZMilitaryService',tableName:'infoREC_ZMilitaryService',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,panelHeight:90" FieldName="MilitaryServiceIDs" MaxLength="128" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="85" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="吸菸" Editor="infocombobox" EditorOptions="valueField:'ID',textField:'Contents',remoteName:'_HRM_REC_User_Management.infoREC_ZSmoking',tableName:'infoREC_ZSmoking',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,panelHeight:100" FieldName="SmokingIDs" MaxLength="128" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="90" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="推薦樁腳" Editor="infocombobox" EditorOptions="valueField:'MemberID',textField:'NameC',remoteName:'_HRM_REC_User_Management.infoPFMemberID',tableName:'infoPFMemberID',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,panelHeight:150" FieldName="PFMemberID" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="90" />
                        
                        <JQTools:JQFormColumn Alignment="left" Caption="同居成員" Editor="infooptions" EditorOptions="title:'同居成員',panelWidth:374,remoteName:'_HRM_REC_User_Management.infoREC_ZCohabits',tableName:'infoREC_ZCohabits',valueField:'ID',textField:'Contents',columnCount:8,multiSelect:true,openDialog:false,selectAll:false,selectOnly:false,items:[]" FieldName="CohabitIDs" Format="" maxlength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="3" Visible="True" Width="90" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="婚姻狀況" Editor="infocombobox" EditorOptions="items:[{value:'未婚',text:'未婚',selected:'false'},{value:'已婚',text:'已婚',selected:'false'},{value:'分居',text:'分居',selected:'false'},{value:'離婚',text:'離婚',selected:'false'}],checkData:false,selectOnly:true,cacheRelationText:false,panelHeight:100" FieldName="Marriage" MaxLength="128" NewRow="True" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="85" />
                        <JQTools:JQFormColumn Alignment="left" Caption="面試來源" Editor="infocombobox" EditorOptions="valueField:'InfoSource',textField:'InfoSource',remoteName:'_HRM_REC_User_Management.infoREC_ZInfoSource',tableName:'infoREC_ZInfoSource',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:150" FieldName="InfoSource" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="2" Visible="True" Width="290" />                        
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="健康評量" Editor="infooptions" EditorOptions="title:'健康評量',panelWidth:900,remoteName:'_HRM_REC_User_Management.infoREC_ZHealthStatus',tableName:'infoREC_ZHealthStatus',valueField:'ID',textField:'Contents',columnCount:20,multiSelect:true,openDialog:false,selectAll:false,onSelect:OnSelectHealthStatusIDs,selectOnly:false,items:[]" FieldName="HealthStatusIDs" Format="" maxlength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="7" Visible="True" Width="90" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="經濟壓力" Editor="infooptions" EditorOptions="title:'經濟壓力',panelWidth:590,remoteName:'_HRM_REC_User_Management.infoREC_ZEcoPressure',tableName:'infoREC_ZEcoPressure',valueField:'ID',textField:'Contents',columnCount:20,multiSelect:true,openDialog:false,selectAll:false,onSelect:OnSelectEcoPressureIDs,selectOnly:false,items:[]" FieldName="EcoPressureIDs" Format="" maxlength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="5" Visible="True" Width="90" />
                        <JQTools:JQFormColumn Alignment="left" Caption="招募區域" Editor="infocombobox" EditorOptions="valueField:'ID',textField:'SalesTeamName',remoteName:'_HRM_REC_User_Management.infoREC_SalesTeam',tableName:'infoREC_SalesTeam',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,onSelect:SalesTeamOnSelect,panelHeight:90" FieldName="ServiceSalesTeam" maxlength="0" NewRow="True" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="85" />
                        <JQTools:JQFormColumn Alignment="left" Caption="招募人員" Editor="infocombobox" EditorOptions="valueField:'ID',textField:'ConsultantName',remoteName:'_HRM_REC_User_Management.infoServiceConsultants',tableName:'infoServiceConsultants',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,panelHeight:90" FieldName="ServiceConsultants" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="130" />
                        <JQTools:JQFormColumn Alignment="left" Caption="薪轉種類" Editor="infocombobox" FieldName="CollarType" ReadOnly="False" Span="1" Visible="True" Width="80" EditorOptions="valueField:'ID',textField:'Name',remoteName:'_HRM_REC_User_Management.infoCollarType',tableName:'infoCollarType',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:120" MaxLength="0" NewRow="False" RowSpan="1" />
...
<%--                        <JQTools:JQFormColumn Alignment="left" Caption="匯款帳號" Editor="text" FieldName="AccountNo" MaxLength="0" NewRow="True" ReadOnly="False" RowSpan="1" Span="6" Visible="True" Width="120" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="infocombobox" EditorOptions="valueField:'BANK_ID',textField:'BANK_CName',remoteName:'_HRM_REC_User_Management.infoHRM_BANK',tableName:'infoHRM_BANK',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,onSelect:BANK_IDOnSelect,panelHeight:90" FieldName="BankID" maxlength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="110" />
                        <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="infocombobox" FieldName="BankBranchID" maxlength="0" Width="110" Span="1" NewRow="False" ReadOnly="False" Visible="True" RowSpan="1" EditorOptions="valueField:'BANKBRANCH_CODE',textField:'BANKBRANCH_CNAME',remoteName:'_HRM_REC_User_Management.infoHRM_BANKBRANCH',tableName:'infoHRM_BANKBRANCH',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,panelHeight:90" />--%>

                        <JQTools:JQFormColumn Alignment="left" Caption="備註" Editor="text" FieldName="Remark" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="4" Visible="True" Width="400" />
                ...
                <JQTools:JQValidate ID="validateMaster" runat="server" BindingObjectID="dataFormMaster" EnableTheming="True">
                    <Columns>
                        ...
                        <JQTools:JQValidateColumn CheckNull="False" FieldName="Email" RemoteMethod="True" ValidateMessage="信箱格式不正確！" ValidateType="EMail" />
...
<%--                        <JQTools:JQGridColumn Alignment="center" Caption="眷屬性別" Editor="infocombobox" EditorOptions="items:[{value:'F',text:'女性',selected:'true'},{value:'M',text:'男性',selected:'false'}],checkData:false,selectOnly:true,cacheRelationText:false,panelHeight:130" FieldName="UserFamilySex" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="80">
                        ...
                        <JQTools:JQGridColumn Alignment="center" Caption="關係" Editor="infocombobox" EditorOptions="valueField:'RELATION_ID',textField:'RELATION_NAME',remoteName:'_HRM_REC_User_Management.infoRELATION',tableName:'infoRELATION',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,panelHeight:130" FieldName="Relation_ID" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="110">
                        </JQTools:JQGridColumn>
                ...
                <JQTools:JQValidate ID="validateMaster2" runat="server" BindingObjectID="dataFormMaster2" EnableTheming="True">
                    <Columns>
                        ...
                        <JQTools:JQValidateColumn CheckNull="True" FieldName="InfoSource" RemoteMethod="True" ValidateMessage="請選擇面試來源！" ValidateType="None" />
                    </Columns>
                </JQTools:JQValidate>
                ...
                <JQTools:JQDialog ID="JQDialogUserCareer" runat="server" BindingObjectID="DFUserCareer" DialogLeft="100px" DialogTop="20px" Title="工作經驗維護" Width="900px">
                    <JQTools:JQDataForm ID="DFUserCareer" runat="server" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" DataMember="REC_UserCareer" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalColumnsCount="4" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" OnApplied="OnAppliedCareer" OnApply="OnApplyCareer" OnLoadSuccess="OnLoadSuccessCareer" ParentObjectID="dataFormMaster" RemoteName="_HRM_REC_User_Management.REC_User" ShowApplyButton="False" ValidateStyle="Dialog" VerticalGap="0">
                        <Columns>
                            ...
                            <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="infocombobox" FieldName="JobPeriodE" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="80" EditorOptions="valueField:'sID',textField:'sDate',remoteName:'_HRM_REC_User_Management.infoJobPeriod2',tableName:'infoJobPeriod2',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" />                            
...
<%--                            <JQTools:JQValidateColumn CheckNull="True" FieldName="JobSalary" RemoteMethod="True" ValidateMessage="薪資待遇不可空白！" ValidateType="None" />--%>
                ...
                <JQTools:JQDialog ID="JQDialogUserFamily" runat="server" BindingObjectID="DFUserFamily" DialogLeft="130px" DialogTop="130px" Title="健保眷屬維護" Width="650px">
                    <JQTools:JQDataForm ID="DFUserFamily" runat="server" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" DataMember="REC_UserFamily" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalColumnsCount="3" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" OnApplied="OnInsertedUserFamily" ParentObjectID="dataFormMaster" RemoteName="_HRM_REC_User_Management.REC_User" ShowApplyButton="False" ValidateStyle="Dialog" VerticalGap="0">
                        <Columns>
...
<%--                            <JQTools:JQFormColumn Alignment="left" Caption="眷屬性別" Editor="infooptions" EditorOptions="title:'JQOptions',panelWidth:150,remoteName:'',tableName:'',valueField:'',textField:'',columnCount:2,multiSelect:false,openDialog:false,selectAll:false,selectOnly:true,items:[{text:'女性',value:'F'},{text:'男性',value:'M'}]" FieldName="UserFamilySex" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="80" />--%>
                            <JQTools:JQFormColumn Alignment="left" Caption="關係" Editor="infocombobox" EditorOptions="valueField:'RELATION_ID',textField:'RELATION_NAME',remoteName:'_HRM_REC_User_Management.infoRELATION',tableName:'infoRELATION',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,panelHeight:130" FieldName="Relation_ID" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="120" />
...
<%--                            <JQTools:JQValidateColumn CheckNull="True" FieldName="UserFamilySex" RemoteMethod="True" ValidateMessage="請選擇眷屬性別！" ValidateType="None" />--%>
                ...
                <JQTools:JQDialog ID="JQDialogJobAssignLogs" runat="server" BindingObjectID="dataFormMaster8" Title="派任紀錄" Width="900px" DialogLeft="36px" DialogTop="20px" Height="440px" EditMode="Dialog" ShowSubmitDiv="False">
                    <JQTools:JQDataForm ID="dataFormMaster8" runat="server" AlwaysReadOnly="False" ChainDataFormID="" Closed="False" ContinueAdd="False" DataMember="REC_User" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalColumnsCount="7" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ParentObjectID="dataFormMaster" RemoteName="_HRM_REC_User_Management.REC_User" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0">
                        <Columns>
                    ...
                    <fieldset>
                        ...
                        <JQTools:JQDataGrid ID="DGJobAssignLogs" runat="server" AllowAdd="True" AllowDelete="True" AllowUpdate="True" AlwaysClose="True" AutoApply="True" BufferView="False" CheckOnSelect="False" ColumnsHibeable="False" DataMember="Rec_JobAssignLogs" DeleteCommandVisible="True" DuplicateCheck="False" EditDialogID="JQDialogAssignLogs" EditMode="Dialog" EditOnEnter="True" InsertCommandVisible="False" MultiSelect="False" NotInitGrid="False" OnUpdate="AssignUpdateRow" PageList="5,10,15,20" PageSize="5" Pagination="False" ParentObjectID="dataFormMaster8" QueryAutoColumn="False" QueryLeft="15px" QueryMode="Panel" QueryTitle="" QueryTop="50px" RecordLock="False" RecordLockMode="None" RemoteName="_HRM_REC_User_Management.REC_User" RowNumbers="True" Title="" TotalCaption="Total:" UpdateCommandVisible="True" ViewCommandVisible="True" Width="100%" OnDeleted="OnDeletedAssignLogs" OnDelete="AssignDeleteRow" Height="310px">
                            <Columns>
                                ...
                                <JQTools:JQGridColumn Alignment="center" Caption="派任狀態" Editor="infocombobox" FieldName="AssignID" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="55" EditorOptions="valueField:'AssignID',textField:'AssignName',remoteName:'_HRM_REC_User_Management.infoREC_ZAssignStep',tableName:'infoREC_ZAssignStep',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200">
                                </JQTools:JQGridColumn>
                                ...
                                <JQTools:JQGridColumn Alignment="center" Caption="派任人員" Editor="infocombobox" EditorOptions="valueField:'ID',textField:'ConsultantName',remoteName:'_HRM_REC_User_Management.infoRecID',tableName:'infoRecID',pageSize:'-1',checkData:true,selectOnly:true,cacheRelationText:false,panelHeight:200" FieldName="RecID" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="70">
                                </JQTools:JQGridColumn>
                        ...
                        <JQTools:JQDialog ID="JQDialogAssignLogs" runat="server" BindingObjectID="DFJobAssignLogs" DialogLeft="120px" DialogTop="45px" Title="派任紀錄維護" Width="750px" ShowSubmitDiv="True">
                            <JQTools:JQDataForm ID="DFJobAssignLogs" runat="server" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" DataMember="Rec_JobAssignLogs" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalColumnsCount="4" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ParentObjectID="dataFormMaster8" RemoteName="_HRM_REC_User_Management.REC_User" ShowApplyButton="False" ValidateStyle="Dialog" VerticalGap="0" OnApplied="OnAppliedAssignLogs" OnLoadSuccess="OnLoadAssignLogs" OnApply="OnApplyAssignLogs">
                                <Columns>
                                    ...
                                    <JQTools:JQFormColumn Alignment="left" Caption="招募人員" Editor="infocombobox" EditorOptions="valueField:'ID',textField:'ConsultantName',remoteName:'_HRM_REC_User_Management.infoRecID',tableName:'infoRecID',pageSize:'-1',checkData:true,selectOnly:false,cacheRelationText:false,panelHeight:200" FieldName="RecID" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="100" />
                ...
                <JQTools:JQDialog ID="JQDialogApplyJob" runat="server" BindingObjectID="dataFormMaster9" Title="應徵紀錄" Width="835px" DialogLeft="80px" DialogTop="10px" Height="460px" EditMode="Dialog" ShowSubmitDiv="False">
                    <JQTools:JQDataForm ID="dataFormMaster9" runat="server" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" DataMember="REC_User" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalColumnsCount="7" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" RemoteName="_HRM_REC_User_Management.REC_User" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" ParentObjectID="dataFormMaster" ChainDataFormID="">
                        <Columns>
                            <JQTools:JQFormColumn Alignment="left" Caption="人才編號" Editor="text" FieldName="UserID" MaxLength="0" NewRow="False" ReadOnly="True" RowSpan="1" Span="1" Visible="True" Width="80" />
