<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ERP_Report_InvoiceDetails_WarrantDetails.aspx.cs" Inherits="Template_JQueryQuery1" %>
...
<head runat="server">
    ...
    <script>
        ...
        function queryGrid(dg) {//查詢後添加固定條件
            ...
            var ARDateFrom = $('#ARDate_Query').datebox('getValue');
            var ARDateTo = $('#ARDate_Query[infolight-options*="~"] ').datebox('getValue');
            //var arrPayWayID = $("#PayWayID_Query").combogrid("getValues");
            ...
            var url = "../JB_ADMIN/REPORT/ERP/ERP_Report_InvoiceDetails_WarrantDetails_RV.aspx?InsGroupID=" + InsGroupID + "&CustomerID=" + CustomerID + "&SalesTypeID=" + SalesTypeID + "&SalesID=" + SalesID + "&SalesDateFrom=" + SalesDateFrom + "&SalesDateTo=" + SalesDateTo + "&ARDateFrom=" + ARDateFrom + "&ARDateTo=" + ARDateTo + "&ReportType=" + ReportType;// + "&PayWayID=" + PayWayID;// + "&iType=" + iType + "&CompanyText=" + CompanyText;
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="sERP_Report_InvoiceDetails_WarrantDetails.InvoiceDetails" runat="server" AutoApply="True"
                ...
                <QueryColumns>
                    <JQTools:JQQueryColumn AndOr="and" Caption="公司別" Condition="in" DataType="number" Editor="infocombogrid" EditorOptions="panelWidth:350,valueField:'InsGroupID',textField:'ShortName',remoteName:'sERP_Report_InvoiceDetails_WarrantDetails.InsGroup',tableName:'InsGroup',valueFieldCaption:'公司別代碼',textFieldCaption:'公司別簡稱',selectOnly:false,checkData:false,columns:[],cacheRelationText:false,multiple:true" FieldName="InsGroupID" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
                    <%--<JQTools:JQQueryColumn AndOr="and" Caption="客戶" Condition="=" DataType="string" Editor="inforefval" EditorOptions="title:'客戶',panelWidth:350,panelHeight:400,remoteName:'sERP_Report_InvoiceDetails_WarrantDetails.Customer',tableName:'Customer',columns:[],columnMatches:[],whereItems:[],valueField:'CustomerID',textField:'ShortName',valueFieldCaption:'ID',textFieldCaption:'簡稱',cacheRelationText:false,checkData:false,showValueAndText:false,dialogCenter:false,selectOnly:true,capsLock:'none',fixTextbox:'false'" FieldName="CustomerID" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />--%>
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="銷貨日起迄" Condition="=" DataType="datetime" Editor="datebox" FieldName="SalesDate" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="收款日起迄" Condition="=" DataType="datetime" Editor="datebox" FieldName="ARDate" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
                    <JQTools:JQQueryColumn AndOr="and" Caption="~" Condition="=" DataType="datetime" Editor="datebox" FieldName="ARDate" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="銷貨類別" Condition="=" DataType="string" Editor="infocombogrid" EditorOptions="panelWidth:350,valueField:'SalesTypeID',textField:'SalesTypeName',remoteName:'sERP_Report_InvoiceDetails_WarrantDetails.SalesType',tableName:'SalesType',valueFieldCaption:'銷貨類別代碼',textFieldCaption:'銷貨類別',selectOnly:false,checkData:false,columns:[],cacheRelationText:false,multiple:true" FieldName="SalesTypeID" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
                    <%--<JQTools:JQQueryColumn AndOr="and" Caption="付款方式" Condition="%" DataType="string" Editor="infocombogrid" FieldName="PayWayID" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="0" Width="125" EditorOptions="panelWidth:350,valueField:'PayWayID',textField:'PayWayName',remoteName:'sERP_Report_InvoiceDetails_WarrantDetails.PayWay',tableName:'PayWay',valueFieldCaption:'付款方式代碼',textFieldCaption:'付款方式',selectOnly:true,checkData:false,columns:[],cacheRelationText:false,multiple:false" />--%>
                    <JQTools:JQQueryColumn AndOr="and" Caption="資料內容" Condition="=" DataType="string" Editor="infooptions" EditorOptions="title:'JQOptions',panelWidth:300,remoteName:'',tableName:'',valueField:'',textField:'',columnCount:3,multiSelect:false,openDialog:false,selectAll:false,selectOnly:false,items:[{text:'全部',value:'1'},{text:'未收',value:'2'},{text:'已收',value:'3'}]" FieldName="ReportType" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="2" Width="125" DefaultValue="1" />
                </QueryColumns>
            </JQTools:JQDataGrid>
        </div>
