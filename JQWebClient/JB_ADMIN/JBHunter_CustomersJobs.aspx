    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var flagIDs = ['#dataFormDetailJobWorkContent', '#dataFormDetailJobName', '#dataFormDetailJobFunctionID', '#dataFormDetailJobRequirement', '#dataFormDetailJobNeedCount'
                ...
                , '#dataFormDetailJobWorkArea', '#dataFormMasterIndustryType', '#dataFormDetailJobLangID1', '#dataFormDetailJobLangID2',
            ...
            var CustTaxNo = $('#dataFormMasterCustTaxNo').closest('td');
            CustTaxNo.append(EconmicLink);
    ...
    <form id="form1" runat="server">
                    ...
                    <td colspan="2" class="auto-style1">
                        ...
                        <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sCustomersJobs.HUT_Customer" runat="server" AutoApply="True" 
                            ...
                            <QueryColumns>
                                ...
                                <JQTools:JQQueryColumn Caption="客戶名稱" Condition="%%" DataType="string" Editor="text" FieldName="CustName" NewLine="True" RemoteMethod="False" Width="180" AndOr="" />
                        ...
                        <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="客戶資料" DialogLeft="10px" DialogTop="10px" Width="1080px" Wrap="False" EditMode="Dialog">
                            <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="HUT_Customer" HorizontalColumnsCount="5" RemoteName="sCustomersJobs.HUT_Customer" Closed="False" ContinueAdd="False" DuplicateCheck="False" IsAutoPageClose="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" OnApplied="MasterGridReload" disapply="False" IsRejectON="False" OnLoadSuccess="Showtooltip" IsAutoPause="False" AlwaysReadOnly="False" DivFramed="False" HorizontalGap="0" VerticalGap="0">
                                <Columns>
                                    ...
                                    <JQTools:JQFormColumn Alignment="left" Caption="聯絡人(1)" Editor="text" FieldName="ContactName1" MaxLength="20" Width="100" Span="1" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="職稱" Editor="text" FieldName="ContactTitle1" MaxLength="100" Width="250" Span="1" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="電話" Editor="text" FieldName="ContactTelArea1" MaxLength="0" Width="25" Span="1" />
                                    <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContactTel1" MaxLength="20" Width="78" />
                                    <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContactTelExt1" MaxLength="10" Width="50" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="手機" Editor="text" FieldName="ContactMobile1" MaxLength="20" Width="100" RowSpan="1" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="eMail" Editor="text" FieldName="ContacteMail1" MaxLength="128" Width="250" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="即時通類型" Editor="infocombobox" FieldName="ContIMType1" MaxLength="20" Width="116" EditorOptions="valueField:'IMNAME',textField:'IMNAME',remoteName:'sCustomersJobs.HUT_ZIMType',tableName:'HUT_ZIMType',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" />
                                    <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContIMNO1" MaxLength="0" Width="90" Span="2" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="聯絡人(2)" Editor="text" FieldName="ContactName2" MaxLength="20" Width="100" Span="1" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="職稱" Editor="text" FieldName="ContactTitle2" MaxLength="100" Width="250" Span="1" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="電話" Editor="text" FieldName="ContactTelArea2" MaxLength="0" Width="25" Span="1" />
                                    <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContactTel2" MaxLength="20" Width="80" />
                                    <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContactTelExt2" MaxLength="10" Width="30" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="手機" Editor="text" FieldName="ContactMobile2" MaxLength="20" Width="100" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="eMail" Editor="text" FieldName="ContacteMail2" MaxLength="128" Width="250" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="即時通類型" Editor="infocombobox" FieldName="ContIMType2" MaxLength="20" Width="116" EditorOptions="valueField:'IMNAME',textField:'IMNAME',remoteName:'sCustomersJobs.HUT_ZIMType',tableName:'HUT_ZIMType',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" />
                                    <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContIMNO2" MaxLength="0" Width="90" Span="2" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="聯絡人(3)" Editor="text" FieldName="ContactName3" MaxLength="20" Width="100" Span="1" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="職稱" Editor="text" FieldName="ContactTitle3" MaxLength="100" Width="250" Span="1" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="電話" Editor="text" FieldName="ContactTelArea3" MaxLength="0" Width="25" Span="1" />
                                    <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContactTel3" MaxLength="20" Width="80" />
                                    <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContactTelExt3" MaxLength="10" Width="30" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="手機" Editor="text" FieldName="ContactMobile3" MaxLength="20" Width="100" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="eMail" Editor="text" FieldName="ContacteMail3" MaxLength="128" Width="250" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="即時通類型" Editor="infocombobox" FieldName="ContIMType3" MaxLength="20" Width="116" EditorOptions="valueField:'IMNAME',textField:'IMNAME',remoteName:'sCustomersJobs.HUT_ZIMType',tableName:'HUT_ZIMType',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" />
                                    <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContIMNO3" MaxLength="0" Width="90" Span="2" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="聯絡人備註" Editor="textarea" FieldName="ContactMark" MaxLength="512" Width="386" Span="5" EditorOptions="height:80" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="福利要項" Editor="textarea" FieldName="Benefits" MaxLength="1024" Width="512" EditorOptions="height:120" Span="5" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="上班時間" Editor="textarea" FieldName="WorkTime" MaxLength="1024" Width="512" Span="5" EditorOptions="height:120" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="招募重點" Editor="textarea" FieldName="RecruitNotes" MaxLength="0" Width="640" Span="5" EditorOptions="height:145" ReadOnly="False" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="複試重點" Editor="textarea" FieldName="ReviewNotes" MaxLength="0" Width="640" Span="5" EditorOptions="height:145" ReadOnly="False"  />
                                    <JQTools:JQFormColumn Alignment="left" Caption="客戶編號" Editor="text" FieldName="CustID" MaxLength="20" Width="100" Span="1" ReadOnly="True" Visible="False" />

                                    <JQTools:JQFormColumn Alignment="left" Caption="客戶名稱" Editor="text" FieldName="CustName" MaxLength="128" Span="2" Width="230" />

                                    <JQTools:JQFormColumn Alignment="left" Caption="網址" Editor="text" FieldName="CustomerUrl" MaxLength="256" Width="280" Span="2" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="負責人" Editor="text" FieldName="PersonName" MaxLength="20" Width="100" Span="1" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="統一編號" Editor="text" FieldName="CustTaxNo" MaxLength="10" Width="100" Span="2" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="地區" Editor="text" FieldName="CustomerArea" MaxLength="128" Width="180" Span="1" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="詳細地址" Editor="text" FieldName="CustomerAddress" MaxLength="128" Width="230" Span="2" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="電話" Editor="text" FieldName="CustomerTelArea" MaxLength="0" Width="30" Span="1" Visible="True" NewRow="True" />
                                    <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="CustomerTel" Width="90" MaxLength="20" />
                                    <JQTools:JQFormColumn Alignment="left" Caption="業務單位" Editor="infocombobox" FieldName="SalesTeamID" MaxLength="0" Width="100" Span="1" Visible="True" EditorOptions="valueField:'ID',textField:'SalesTeamName',remoteName:'sSalesTeam.HUT_SalesTeam',tableName:'HUT_SalesTeam',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200"/>
                                 
                                    <JQTools:JQFormColumn Alignment="left" Caption="業務人員" Editor="infocombobox" FieldName="HunterID" MaxLength="0" Width="130" EditorOptions="valueField:'ID',textField:'HunterName',remoteName:'sCustomersJobs.HUT_Hunter',tableName:'HUT_Hunter',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" />
                            ...
                            <JQTools:JQDialog ID="JQDialog2" runat="server" BindingObjectID="dataFormDetail" Title="職缺資料" Width="1080px" DialogLeft="50px" DialogTop="25px">
                                <JQTools:JQDataForm ID="dataFormDetail" runat="server" ParentObjectID="dataFormMaster" DataMember="HUT_Job" BackColor="Yellow" HorizontalColumnsCount="7" RemoteName="sCustomersJobs.HUT_Customer" Closed="False" ContinueAdd="False" DuplicateCheck="False" IsAutoPageClose="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" disapply="False" IsRejectON="False" Width="1120px" OnLoadSuccess="dataFormLoadSucess" OnApplied="MasterGridReload" IsAutoPause="False">
                                    <Columns>
                                        ...
                                        <JQTools:JQFormColumn Alignment="left" Caption="召募重點" Editor="textarea" EditorOptions="height:230" FieldName="RecruitNotes" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="4" Visible="False" Width="600" />
                                        <JQTools:JQFormColumn Alignment="left" Caption="複試重點" Editor="textarea" EditorOptions="height:230" FieldName="ReviewNotes" ReadOnly="False" Span="7" Visible="False" Width="600" />
        ...
        <script>
            $(function () {
                ...
                var MyArray1 = { 客戶資料: 8, 福利出勤: 2, 公告欄位: 2 };
