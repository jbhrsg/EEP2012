<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Media_Report_PaperReceivablePayableList.aspx.cs" Inherits="Template_JQueryQuery1" %>
...
<head runat="server">
    ...
    <script>
        ...
        function queryGrid(dg) {//查詢後添加固定條件
            ...
            var url = "../JB_ADMIN/REPORT/Media/Media_Report_PaperReceivablePayableList_RV.aspx?CustNO=" + CustNO + "&SalesID=" + SalesID + "&SalesDateFrom=" + SalesDateFrom + "&SalesDateTo=" + SalesDateTo + "&NewsTypeID=" + NewsTypeID + "&NewsAreaID=" + NewsAreaID + "&NewsPublishID=" + NewsPublishID + "&ReportType=" + ReportType;// + "&iType=" + iType + "&CompanyText=" + CompanyText;
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="sMedia_Report_PaperReceivablePayableList.ERPSalesDetails" runat="server" AutoApply="True"
                ...
                <QueryColumns>
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="報表格式" Condition="%" DataType="string" Editor="infooptions" EditorOptions="title:'JQOptions',panelWidth:350,remoteName:'',tableName:'',valueField:'',textField:'',columnCount:5,multiSelect:false,openDialog:false,selectAll:false,selectOnly:false,items:[{text:'明細',value:'1'},{text:'彙總',value:'2'},{text:'業務',value:'3'},{text:'月份',value:'4'}]" FieldName="ReportType" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="2" Width="200" />
                </QueryColumns>
            </JQTools:JQDataGrid>
        </div>
