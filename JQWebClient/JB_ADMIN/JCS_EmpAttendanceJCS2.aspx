<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JCS_EmpAttendanceJCS2.aspx.cs" Inherits="Template_JQuerySingle1" %>
<!DOCTYPE html>
<html>
<head runat="server">
    ...
    <title></title>
      ...
      <script type="text/javascript">
          ...
          function GetEmpListPeriod() {
                ...
                $.ajax({
                      type: "POST",
                      url: '../handler/jqDataHandle.ashx?RemoteName=sJCS2EmpAttendance.EmpAttendance',
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sJCS2EmpAttendance.EmpAttendance" runat="server" AutoApply="True"
                ...
                <QueryColumns>
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="員工" Condition="=" DataType="string" Editor="infocombobox" EditorOptions="valueField:'EMPID',textField:'NAMEC',remoteName:'sJCS2EmpAttendance.EmpListPeriod',tableName:'EmpListPeriod',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" FieldName="EMPID" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
                </QueryColumns>
            </JQTools:JQDataGrid>

            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="傑誠員工出勤查詢">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="EmpAttendance" HorizontalColumnsCount="2" RemoteName="sJCS2EmpAttendance.EmpAttendance" >
                    <Columns>
