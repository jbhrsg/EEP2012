<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JBJCS1_Customers.aspx.cs" Inherits="Template_JQuerySingle1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sJCSCustomer.Customers1" runat="server" AutoApply="True"
                DataMember="Customers1" Pagination="True" QueryTitle="" EditDialogID="JQDialog1"
                Title="平鎮宿舍客戶資料維護" QueryMode="Panel" AllowAdd="True" AllowDelete="True" AllowUpdate="True" AlwaysClose="False" BufferView="False" CheckOnSelect="True" ColumnsHibeable="False" DeleteCommandVisible="False" DuplicateCheck="False" EditMode="Dialog" EditOnEnter="True" InsertCommandVisible="True" MultiSelect="False" NotInitGrid="False" PageList="10,20,30,40,50" PageSize="10" QueryAutoColumn="False" QueryLeft="" QueryTop="" RecordLock="False" RecordLockMode="None" RowNumbers="True" TotalCaption="Total:" UpdateCommandVisible="True" ViewCommandVisible="False">
                <Columns>
            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="平鎮客戶維護" DialogLeft="50px" DialogTop="50px" Width="1030px">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="Customers1" HorizontalColumnsCount="7" RemoteName="sJCSCustomer.Customers1" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" OnApplied="OnAppliedCus" >
                    <Columns>
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="負責業務" Editor="infocombobox" FieldName="SalesID" Format="" Width="105" EditorOptions="valueField:'ID',textField:'Name',remoteName:'sJCSCustomer.infoSalesId1',tableName:'infoSalesId1',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" maxlength="0" />
