<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JBREQ_ShortTermMaster.aspx.cs" Inherits="Template_JQuerySingle1" %>
<!DOCTYPE html>
<html>
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var Btn = $('<a>', { href: "javascript:void(0)" }).bind('click', function () {
             ...
             openForm('#JQDialog4', {}, "", 'dialog');}).linkbutton({ text: '檢視費用' });
                ...
                if (parameters == 'SETBILL') {
                    $('#dataFormMasterShortTermNO').after($('<a>', { href: 'javascript:void(0)' }).on('click', function () {
                       ...
                       for (var i = 0 ; i < cnt ; i++) {
                           ...
                           $.ajax({
                               type: "POST",
                               url: '../handler/jqDataHandle.ashx?RemoteName=sShortTermMasterApply.ShortTermMaster',
        ...
        function dataFormDetailOnApply() {
            ...
            if ($("#dataFormDetailRequisitionAmount").val() > 0) {
                var ReqPayTo = $("#dataFormDetailReqPayTo").refval('getValue');
                if (ReqPayTo == "" || ReqPayTo == undefined) {
                    alert('注意,當請款金額>0時,請款受款人必須選取');
                    return false;
                }
                var ReqPayTypeID = $("#dataFormDetailReqPayTypeID").combobox('getValue');
                if (ReqPayTypeID == "" || ReqPayTypeID == undefined) {
                    alert('注意,當請款金額>0時,請款支付方式必須選取');
                    return false;
                }
                var ReqPlanPayDate = $("#dataFormDetailReqPlanPayDate").datebox('getValue');
                if (ReqPlanPayDate == "" || ReqPlanPayDate == undefined) {
                    alert('注意,當請款金額>0時,請款預付日期必須填入');
                    return false;
                }
        ...
        function SumFeeAmount(rowData) {
            //$("#dataFormMasterInvoiceAmt").val(rowData.SalesTotal);
            //alert('OK');
            //$("#dataFormDetailRequisitionAmount").val(rowData.FeeAmount);
            //return true;
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title=" 多筆暫借款申請" DialogLeft="10px" DialogTop="10px" Width="880px">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="ShortTermMaster" HorizontalColumnsCount="2" RemoteName="sShortTermMasterApply.ShortTermMaster" IsAutoPageClose="True" IsAutoSubmit="True" IsShowFlowIcon="True" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalGap="0" IsAutoPause="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" OnLoadSuccess=" dataFormMaster_OnLoadSuccess" OnCancel="CloseDataForm" OnApply="dataFormMasterOnApply" >

                    <Columns>
                        <JQTools:JQFormColumn Alignment="left" Caption="暫借單編號" Editor="text" FieldName="ShortTermNO" Format="" maxlength="0" Width="140" ReadOnly="True" Visible="True" />
                        <JQTools:JQFormColumn Alignment="left" Caption="申請日期" Editor="datebox" FieldName="ShortTermDate" Format="yyyy/mm/dd" Width="145" Visible="True" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="申請部門" Editor="infocombobox" FieldName="ApplyOrg_NO" Format="" Width="144" EditorOptions="valueField:'ORG_NO',textField:'ORG_DESC',remoteName:'sShortTermMaster.Organization',tableName:'Organization',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" Visible="True" maxlength="0" Span="1" />
                        <JQTools:JQFormColumn Alignment="left" Caption="Org_NOParent" Editor="text" FieldName="Org_NOParent" Format="" Width="144" Visible="False" ReadOnly="False" />
                        <JQTools:JQFormColumn Alignment="left" Caption="暫借款類別" Editor="infocombobox" FieldName="ShortTermTypeID" Format="" Width="144" EditorOptions="valueField:'ShortTermTypeID',textField:'ShortTermTypeName',remoteName:'sShortTermMaster.ShortTermType',tableName:'ShortTermType',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" ReadOnly="False" maxlength="0" Visible="True" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="年月" Editor="infocombobox" EditorOptions="valueField:'YearMonth',textField:'YearMonth',remoteName:'sShortTermMasterApply.YearMonth',tableName:'YearMonth',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" FieldName="YearMonth" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="144" OnBlur="" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="暫借事由" Editor="text" FieldName="ShortTermGist" Format="" Width="480" ReadOnly="False" maxlength="0" Visible="True" NewRow="False" RowSpan="1" Span="1" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="請款備註" Editor="text" FieldName="PleaseNote" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="480" />
                ...
                <JQTools:JQDataGrid ID="dataGridDetail" runat="server" AutoApply="False" DataMember="ShortTermDetails" EditDialogID="JQDialog2" Pagination="False" ParentObjectID="dataFormMaster" RemoteName="sShortTermMasterApply.ShortTermMaster" Title="明細資料" AllowAdd="True" AllowDelete="True" AllowUpdate="True" AlwaysClose="True" BufferView="False" CheckOnSelect="True" ColumnsHibeable="False" DeleteCommandVisible="False" DuplicateCheck="False" EditMode="Dialog" EditOnEnter="True" InsertCommandVisible="True" MultiSelect="False" NotInitGrid="False" PageList="10,20,30,40,50" PageSize="10" QueryAutoColumn="False" QueryLeft="" QueryMode="Window" QueryTitle="Query" QueryTop="" RecordLock="False" RecordLockMode="None" RowNumbers="False" TotalCaption="合計:" UpdateCommandVisible="False" ViewCommandVisible="True" OnDelete="DataGridDetailOnDelete" OnInsert="DataGridDetailOnInsert" >
                    <Columns>
                        ...
                        <JQTools:JQGridColumn Alignment="right" Caption="暫借金額" Editor="numberbox" FieldName="ShortTermAmount" Format="N" Width="60" Total="sum" OnTotal="SumShortTermAmount" Visible="True" />
                        <JQTools:JQGridColumn Alignment="right" Caption="請款金額" Editor="text" FieldName="RequisitionAmount" Format="N" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="80" />
                        <JQTools:JQGridColumn Alignment="left" Caption="支付方式" Editor="infocombobox" FieldName="PayTypeID" Format="" Width="60" EditorOptions="valueField:'PayTypeID',textField:'PayTypeName',remoteName:'sShortTermMaster.PayType',tableName:'PayType',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" Visible="True" />
                        ...
                        <JQTools:JQGridColumn Alignment="left" Caption="成本備註" Editor="text" FieldName="CostNotes" Format="" Width="200" Visible="True" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" />
                        ...
                        <JQTools:JQGridColumn Alignment="left" Caption="FeeID" Editor="text" FieldName="FeeID" Visible="False" Width="80" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" />
                        ...
                        <JQTools:JQGridColumn Alignment="left" Caption="FeeSDate" Editor="text" FieldName="FeeSDate" Visible="False" Width="80" />
                        <JQTools:JQGridColumn Alignment="left" Caption="FeeEDate" Editor="text" FieldName="FeeEDate" Visible="False" Width="80" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" />
                        <JQTools:JQGridColumn Alignment="left" Caption="OriginalAmount" Editor="text" FieldName="OriginalAmount" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="False" Width="80">
                        </JQTools:JQGridColumn>
                        <JQTools:JQGridColumn Alignment="left" Caption="RequisitionAmount" Editor="text" FieldName="RequisitionAmount" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="False" Width="80">
                        </JQTools:JQGridColumn>
                    </Columns>
                    <RelationColumns>
                ...
                <JQTools:JQDialog ID="JQDialog2" runat="server" BindingObjectID="dataFormDetail" DialogLeft="15px" DialogTop="40px" Width="620px" Title="暫借款明細資料">
                    <JQTools:JQDataForm ID="dataFormDetail" runat="server" ParentObjectID="dataFormMaster" DataMember="ShortTermDetails" HorizontalColumnsCount="2" RemoteName="sShortTermMasterApply.ShortTermDetails" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" OnApply="dataFormDetailOnApply" OnLoadSuccess="dataFormDetailOnLoadSucess" >
                        <Columns>
                            ...
                            <JQTools:JQFormColumn Alignment="left" Caption="宿舍" Editor="infocombobox" EditorOptions="valueField:'DORMID',textField:'DormName',remoteName:'sShortTermMasterApply.Dorm',tableName:'Dorm',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,onSelect:DormOnSelect,panelHeight:200" FieldName="DormID" ReadOnly="False" Span="1" Width="120" />
                            <JQTools:JQFormColumn Alignment="left" Caption="費用項目" Editor="infocombobox" EditorOptions="valueField:'FeeID',textField:'FeeName',remoteName:'sShortTermMasterApply.FeeItem',tableName:'FeeItem',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,panelHeight:200" FieldName="FeeID" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="2" Visible="True" Width="120" />
                            ...
                            <JQTools:JQFormColumn Alignment="right" Caption="原始金額" Editor="numberbox" FieldName="OriginalAmount" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="120" Format="N" />
                            <JQTools:JQFormColumn Alignment="right" Caption="請款金額" Editor="numberbox" FieldName="RequisitionAmount" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="113" Format="N" />
                            <JQTools:JQFormColumn Alignment="right" Caption="暫借金額" Editor="numberbox" FieldName="ShortTermAmount" Format="N" Width="120" Span="1" Visible="True" ReadOnly="False" />
                            <JQTools:JQFormColumn Alignment="left" Caption="支付方式" Editor="infocombobox" EditorOptions="valueField:'PayTypeID',textField:'PayTypeName',remoteName:'sShortTermMaster.PayType',tableName:'PayType',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" FieldName="PayTypeID" Format="" Span="1" Width="120" Visible="True" ReadOnly="False" />
                            ...
                            <JQTools:JQFormColumn Alignment="left" Caption="CreateDate" Editor="datebox" FieldName="CreateDate" Format="" Visible="False" Width="120" ReadOnly="False" Span="1" MaxLength="0" NewRow="False" RowSpan="1" />
