<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FWCRMEmpFeesUpdate.aspx.cs" Inherits="Template_JQuerySingle1" %>
    ...
    <script>
        ...
        function queryGrid(dg) {//查詢後添加固定條件
            if ($(dg).attr('id') == 'dataGridView') {
                ...
                if (CompanyID != "") {
                    var result = [];
                    var CompID = $('#CompanyID_Query').combobox('getValue');//公司別
...
<%--                    <JQTools:JQGridColumn Alignment="center" Caption="出生年" Editor="numberbox" FieldName="BirthYear" MaxLength="0" Visible="true" Width="60" Sortable="False" />--%>
                ...
                <TooItems>
                    <JQTools:JQToolItem Enabled="True" Icon="icon-cancel" ItemType="easyui-linkbutton" OnClick="EmployeeFeesDetele" Text="刪除選取外勞費用" Visible="True" />
                </TooItems>
                <QueryColumns>
                    <JQTools:JQQueryColumn AndOr="and" Caption="公司別" Condition="%" DataType="string" Editor="infocombobox" EditorOptions="valueField:'CompanyID',textField:'CompName',remoteName:'sPowerData.infoCompID',tableName:'infoCompID',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,onSelect:CompanyID_OnSelect,panelHeight:200" FieldName="CompanyID" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="0" Width="100" />
                    <JQTools:JQQueryColumn AndOr="and" Caption="雇主名稱" Condition="%" DataType="string" Editor="infocombobox" EditorOptions="items:[{value:'',text:'',selected:'false'}],checkData:true,selectOnly:false,cacheRelationText:false,panelHeight:150" FieldName="EmployerID" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="120" />
                    <JQTools:JQQueryColumn AndOr="and" Caption="外勞姓名" Condition="%" DataType="string" Editor="text" FieldName="EmployeeTcName" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="100" />
                </QueryColumns>
            </JQTools:JQDataGrid>
