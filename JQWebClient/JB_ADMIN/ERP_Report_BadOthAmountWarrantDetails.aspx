<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ERP_Report_BadOthAmountWarrantDetails.aspx.cs" Inherits="Template_JQueryQuery1" %>
...
<head runat="server">
    ...
    <script>
        ...
        function queryGrid(dg) {//查詢後添加固定條件
            ...
            var url = "../JB_ADMIN/REPORT/ERP/ERP_Report_BadOthAmountWarrantDetails_RV.aspx?InsGroupID=" + InsGroupID + "&CustomerID=" + CustomerID + "&WarrantDateFrom=" + WarrantDateFrom + "&WarrantDateTo=" + WarrantDateTo + "&ReportType=" + ReportType;// + "&iType=" + iType + "&CompanyText=" + CompanyText;
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="sERP_Report_BadOthAmountWarrantDetails.WarrantDetails" runat="server" AutoApply="True"
                ...
                <QueryColumns>
                    <JQTools:JQQueryColumn AndOr="and" Caption="公司別" Condition="in" DataType="number" Editor="infocombogrid" EditorOptions="panelWidth:350,valueField:'InsGroupID',textField:'ShortName',remoteName:'sERP_Report_BadOthAmountWarrantDetails.InsGroup',tableName:'InsGroup',valueFieldCaption:'公司別代碼',textFieldCaption:'公司別簡稱',selectOnly:false,checkData:false,columns:[],cacheRelationText:false,multiple:true" FieldName="InsGroupID" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
                    <%--<JQTools:JQQueryColumn AndOr="and" Caption="客戶" Condition="=" DataType="string" Editor="inforefval" EditorOptions="title:'客戶',panelWidth:350,panelHeight:400,remoteName:'sERP_Report_BadOthAmountWarrantDetails.Customer',tableName:'Customer',columns:[],columnMatches:[],whereItems:[],valueField:'CustomerID',textField:'ShortName',valueFieldCaption:'ID',textFieldCaption:'簡稱',cacheRelationText:false,checkData:false,showValueAndText:false,dialogCenter:false,selectOnly:true,capsLock:'none',fixTextbox:'false'" FieldName="CustomerID" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />--%>
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="報表格式" Condition="=" DataType="string" Editor="infooptions" EditorOptions="title:'JQOptions',panelWidth:300,remoteName:'',tableName:'',valueField:'',textField:'',columnCount:3,multiSelect:false,openDialog:false,selectAll:false,selectOnly:false,items:[{text:'沖呆帳',value:'1'},{text:'沖其他+折讓+退貨',value:'2'}]" FieldName="ReportType" IsNvarChar="False" NewLine="True" RemoteMethod="False" RowSpan="0" Span="2" Width="125" DefaultValue="1" />
                </QueryColumns>
            </JQTools:JQDataGrid>
        </div>
