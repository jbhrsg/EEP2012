     ...
     <script type="text/javascript">
         ...
         function CheckEmpID() {
             ...
             if (getEditMode($("#dataFormMaster")) == 'inserted') {
                 ...
                 $.ajax({
                     type: "POST",
                     url: '../handler/jqDataHandle.ashx?RemoteName=sJCS2EmpAttendance.Employee',
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sJCS2EmpAttendance.Employee" runat="server" AutoApply="True"
                ...
                <QueryColumns>
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="員工姓名" Condition="=" DataType="string" Editor="infocombobox" EditorOptions="valueField:'EMPID',textField:'NAMEC',remoteName:'sJCS2EmpAttendance.EMPList',tableName:'EMPList',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" FieldName="EmpID" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
                </QueryColumns>
            </JQTools:JQDataGrid>

            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="傑誠員工出勤" Width="480px">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="Employee" HorizontalColumnsCount="2" RemoteName="sJCS2EmpAttendance.Employee" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" OnLoadSuccess="dataFormMasterOnLoadSucess" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" OnApply="dataFormMasterOnApply" >
                    <Columns>
