<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JBREQ_PayTerm.aspx.cs" Inherits="Template_JQuerySingle1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sReferencesADM.PayTerm" runat="server" AutoApply="True"
                DataMember="PayTerm" Pagination="True" QueryTitle="Query" EditDialogID="JQDialog1"
                ...
                <Columns>
                    <JQTools:JQGridColumn Alignment="left" Caption="代號" Editor="numberbox" FieldName="PayTermID" Format="" Width="60" />
                    <JQTools:JQGridColumn Alignment="left" Caption="名稱" Editor="text" FieldName="PayTermName" Format="" MaxLength="0" Width="360" />
            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="付款條件">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="PayTerm" HorizontalColumnsCount="2" RemoteName="sReferencesADM.PayTerm" Closed="False" ContinueAdd="False" disapply="False" DuplicateCheck="False" IsAutoPageClose="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" >
                    <Columns>
                        <JQTools:JQFormColumn Alignment="left" Caption="代號" Editor="numberbox" FieldName="PayTermID" Format="" Width="180" Span="2" ReadOnly="True" />
                        <JQTools:JQFormColumn Alignment="left" Caption="名稱" Editor="text" FieldName="PayTermName" Format="" maxlength="0" Width="180" />
                ...
                <JQTools:JQDefault ID="defaultMaster" runat="server" BindingObjectID="dataFormMaster" EnableTheming="True">
                    <Columns>
                        <JQTools:JQDefaultColumn CarryOn="False" DefaultValue="0" FieldName="PayTermID" RemoteMethod="True" />
                    </Columns>
                </JQTools:JQDefault>
