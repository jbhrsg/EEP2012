<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JBHunter_CustomersA.aspx.cs" Inherits="Template_JQuerySingle1" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {                     
            ...
            if (queryPanel)
                $(queryPanel).panel('resize', { width: 1000 });
                ...
                <tr>
                    <td colspan="2" class="auto-style1">
                        ...
                        <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sCustomersJobs.HUT_Customer" runat="server" AutoApply="True" 
                            ...
                            Title="客戶資料" AllowAdd="True" AllowDelete="True" AllowUpdate="True" AlwaysClose="False" CheckOnSelect="True" DeleteCommandVisible="False" DuplicateCheck="False" EditMode="Dialog" EditOnEnter="True" InsertCommandVisible="True" MultiSelect="False" PageList="15,30,45,60,65" PageSize="15" QueryAutoColumn="False" QueryLeft="" QueryMode="Panel" QueryTop="" RecordLock="False" TotalCaption="Total:" UpdateCommandVisible="True" ViewCommandVisible="False" OnDelete="CheckDelCustomer" ColumnsHibeable="False" RecordLockMode="None" Width="1000px" BufferView="False" NotInitGrid="False" RowNumbers="True">
                            <Columns>
                                ...
                                <JQTools:JQGridColumn Alignment="left" Caption="客戶名稱" Editor="text" FieldName="CustName" MaxLength="30" Width="233" Sortable="True" />
                                ...
                                <JQTools:JQGridColumn Alignment="center" Caption="最後聯繫日" Editor="datebox" FieldName="ContactDate" Frozen="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="85" FormatScript="" Format="yyyy/mm/dd" />
                                ...
                                <JQTools:JQGridColumn Alignment="center" Caption="建立人員" Editor="text" EditorOptions="" FieldName="CreateBy" Frozen="False" MaxLength="0" QueryCondition="" ReadOnly="True" Sortable="False" Visible="True" Width="80" />
                                <JQTools:JQGridColumn Alignment="center" Caption="建立日期" Editor="datebox" FieldName="CreateDate" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="87">
                        ...
                        <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="客戶資料" DialogLeft="50px" DialogTop="5px" Width="1000px" Wrap="False" EditMode="Dialog">
                            <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="HUT_Customer" HorizontalColumnsCount="5" RemoteName="sCustomersJobs.HUT_Customer" Closed="False" ContinueAdd="False" DuplicateCheck="False" IsAutoPageClose="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsShowFlowIcon="False" ShowApplyButton="False" ValidateStyle="Hint" OnApplied="MasterGridReload" disapply="False" IsRejectON="False"  IsAutoPause="False" AlwaysReadOnly="False" DivFramed="False" HorizontalGap="0" VerticalGap="0" ParentObjectID="" ChainDataFormID="dataFormMaster1" OnLoadSuccess="OnLoadDF">
                                <Columns>
                                    <JQTools:JQFormColumn Alignment="left" Caption="客戶編號" Editor="text" FieldName="CustID" MaxLength="20" Width="100" Span="1" ReadOnly="True" Visible="False" NewRow="False" />
                                    ...
                                    <JQTools:JQFormColumn Alignment="left" Caption="地址" Editor="text" FieldName="CustomerAddress" MaxLength="128" Width="352" Span="1" NewRow="False" ReadOnly="False" Visible="True" />
                                    ...
                                    <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="CustomerUrl" MaxLength="256" Span="1" Width="200" NewRow="False" Visible="True" />
                                 ...
                                 <div style="padding:10px" title="公告欄">
                                     <JQTools:JQDataForm ID="dataFormMaster1" runat="server" AlwaysReadOnly="False" ChainDataFormID="dataFormMaster2" Closed="False" ContinueAdd="False" DataMember="HUT_Customer" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalColumnsCount="2" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="True" IsRejectON="False" IsShowFlowIcon="False" ParentObjectID="" RemoteName="sCustomersJobs.HUT_Customer" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0">
                                         <Columns>
                                             ...
                                             <JQTools:JQFormColumn Alignment=" " Caption="說明" Editor="textarea" EditorOptions="height:300" FieldName="RecruitNotes" MaxLength="0" NewRow="True" ReadOnly="False" RowSpan="1" Span="2" Visible="True" Width="800" />
                                         </Columns>
                                     </JQTools:JQDataForm>
                                 </div>                                
                                 <div style="padding:10px" title="福利要項">
                                     <JQTools:JQDataForm ID="dataFormMaster2" runat="server" AlwaysReadOnly="False" ChainDataFormID="" Closed="False" ContinueAdd="False" DataMember="HUT_Customer" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalColumnsCount="6" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="True" IsRejectON="False" IsShowFlowIcon="False" ParentObjectID="" RemoteName="sCustomersJobs.HUT_Customer" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0">
                                         <Columns>
                                            <JQTools:JQFormColumn Alignment="left" Caption="說明" Editor="textarea" FieldName="Benefits" MaxLength="2000" Width="800" EditorOptions="height:300" Span="5" />
                                         </Columns>
                                     </JQTools:JQDataForm>
                                 </div>
                                 <div style="padding:10px" title="聯繫紀錄">
                                     <JQTools:JQDataGrid ID="DGContactRecord" runat="server" AllowAdd="True" AllowDelete="True" AllowUpdate="True" AlwaysClose="True" AutoApply="False" BufferView="False" CheckOnSelect="False" ColumnsHibeable="False" DataMember="HUT_CustomerContactRecord" DeleteCommandVisible="True" DuplicateCheck="False" EditDialogID="JQDialogContactRecord" EditMode="Dialog" EditOnEnter="True" InsertCommandVisible="False" MultiSelect="False" NotInitGrid="False" OnUpdate="" PageList="10,20,30,40,50" PageSize="10" Pagination="True" ParentObjectID="dataFormMaster" QueryAutoColumn="False" QueryLeft="15px" QueryMode="Panel" QueryTitle="" QueryTop="50px" RecordLock="False" RecordLockMode="None" RemoteName="sCustomersJobs.HUT_Customer" RowNumbers="True" Title="" TotalCaption="Total:" UpdateCommandVisible="True" ViewCommandVisible="False" Width="100%" Height="320px">
                                         <Columns>
                                             ...
                                             <JQTools:JQGridColumn Alignment="left" Caption="聯繫內容" Editor="text" FieldName="Notes" FormatScript="" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="600">
                                             </JQTools:JQGridColumn>
                                     ...
                                     <JQTools:JQDialog ID="JQDialogContactRecord" runat="server" BindingObjectID="DFContactRecord" DialogLeft="120px" DialogTop="120px" Title="聯繫紀錄維護" Width="750px">
                                         <JQTools:JQDataForm ID="DFContactRecord" runat="server" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" DataMember="HUT_CustomerContactRecord" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalColumnsCount="1" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" OnApplied="OnAppliedContactRecord" ParentObjectID="dataFormMaster" RemoteName="sCustomersJobs.HUT_Customer" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0">
                                             <Columns>
                                                 ...
                                                 <JQTools:JQFormColumn Alignment="left" Caption="聯繫內容" Editor="textarea" EditorOptions="height:80" FieldName="Notes" MaxLength="256" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="620" />
                                  ...
                                  <div style="padding:10px" title="聯絡人資訊">
                                     ...
                                     <JQTools:JQDataGrid ID="DGContactPerson" runat="server" AllowAdd="True" AllowDelete="True" AllowUpdate="True" AlwaysClose="True" AutoApply="False" BufferView="False" CheckOnSelect="False" ColumnsHibeable="False" DataMember="HUT_CustomerContactPerson" DeleteCommandVisible="True" DuplicateCheck="False" EditDialogID="JQDialogContactPerson" EditMode="Dialog" EditOnEnter="True" InsertCommandVisible="False" MultiSelect="False" NotInitGrid="False" OnUpdate="" PageList="10,20,30,40,50" PageSize="10" Pagination="True" ParentObjectID="dataFormMaster" QueryAutoColumn="False" QueryLeft="15px" QueryMode="Panel" QueryTitle="" QueryTop="50px" RecordLock="False" RecordLockMode="None" RemoteName="sCustomersJobs.HUT_Customer" RowNumbers="True" Title="" TotalCaption="Total:" UpdateCommandVisible="True" ViewCommandVisible="False" Width="100%" Height="320px">
                                         <Columns>
                                             ...
                                             <JQTools:JQGridColumn Alignment="left" Caption="職稱" Editor="text" FieldName="ContactTitle" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="120">
                                             </JQTools:JQGridColumn>
                                             <JQTools:JQGridColumn Alignment="left" Caption="部門" Editor="text" FieldName="ContactDept" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="100">
                                             </JQTools:JQGridColumn>
                                             ...
                                             <JQTools:JQGridColumn Alignment="left" Caption="國碼" Editor="text" FieldName="ContactMobile1Area" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="60">
                                             </JQTools:JQGridColumn>
                                             ...
                                             <JQTools:JQGridColumn Alignment="left" Caption="ContactMobile1" Editor="text" FieldName="ContactMobile2Area" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="False" Width="80">
                                             </JQTools:JQGridColumn>
                                     ...
                                     <JQTools:JQDialog ID="JQDialogContactPerson" runat="server" BindingObjectID="DFContactPerson" DialogLeft="80px" DialogTop="80px" Title="聯絡人維護" Width="850px">
                                         <JQTools:JQDataForm ID="DFContactPerson" runat="server" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" DataMember="HUT_CustomerContactPerson" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalColumnsCount="4" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" OnApplied="OnAppliedContactPerson" ParentObjectID="dataFormMaster" RemoteName="sCustomersJobs.HUT_Customer" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" OnLoadSuccess="OnLoadSuccessContactPerson">
                                             <Columns>
                                                 ...
                                                 <JQTools:JQFormColumn Alignment="left" Caption="CustID" Editor="text" FieldName="CustID" MaxLength="0" Visible="False" Width="80" NewRow="False" Span="1" />
                                                <JQTools:JQFormColumn Alignment="left" Caption="聯絡人" Editor="text" FieldName="ContactName" MaxLength="20" Width="110" Span="1" NewRow="False" ReadOnly="False" RowSpan="1" Visible="True" />
                                                <JQTools:JQFormColumn Alignment="left" Caption="職稱" Editor="text" FieldName="ContactTitle" MaxLength="100" Width="120" NewRow="False" Span="1" Visible="True" ReadOnly="False" RowSpan="1" />
                                             <JQTools:JQFormColumn Alignment="left" Caption="部門" Editor="text" FieldName="ContactDept" MaxLength="0" Span="1" Width="150" NewRow="False" Visible="True" />
                                            <JQTools:JQFormColumn Alignment="left" Caption="狀態" Editor="infocombobox" FieldName="ContactStatus" MaxLength="0" Width="80" NewRow="False" Span="1" Visible="True" EditorOptions="valueField:'ID',textField:'ContactStatusName',remoteName:'sCustomersJobs.HUT_CustomerContactStatus',tableName:'HUT_CustomerContactStatus',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,panelHeight:200" />
                                            <JQTools:JQFormColumn Alignment="left" Caption="電話" Editor="text" FieldName="ContactTelArea" MaxLength="0" Width="39" Span="4" NewRow="True" Visible="True" RowSpan="1" />
                                             <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContactTel" MaxLength="20" Width="78" NewRow="False" Span="1" Visible="True" />
                                                <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContactTelExt" MaxLength="10" Width="50" NewRow="False" Visible="True" />
                                                 <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContacteMail" MaxLength="128" NewRow="False" Span="1" Visible="True" Width="330" ReadOnly="False" RowSpan="1" />
                                                 <JQTools:JQFormColumn Alignment="left" Caption="手機1" Editor="infocombobox" FieldName="ContactMobile1Area" MaxLength="0" NewRow="True" Visible="True" Width="90" ReadOnly="False" RowSpan="1" Span="4" EditorOptions="valueField:'ContactMobile1Area',textField:'ContactMobile1Area',remoteName:'sCustomersJobs.infoContactMobile1Area',tableName:'infoContactMobile1Area',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" />
                                                 <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContactMobile1" MaxLength="20" Width="130" NewRow="True" Span="1" OnBlur="" />
                                                 <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="infocombobox" FieldName="ContactMobile2Area" MaxLength="0" NewRow="False" Span="1" Width="90" ReadOnly="False" RowSpan="1" Visible="True" EditorOptions="valueField:'ContactMobile1Area',textField:'ContactMobile1Area',remoteName:'sCustomersJobs.infoContactMobile1Area',tableName:'infoContactMobile1Area',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" />
                                                <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContactMobile2" MaxLength="0" Width="130" Span="1" NewRow="False" />
                                                <JQTools:JQFormColumn Alignment="left" Caption="即時通1" Editor="infocombobox" FieldName="ContIMType1" MaxLength="20" Width="90" EditorOptions="valueField:'ID',textField:'IMNAME',remoteName:'sCustomersJobs.HUT_ZIMType',tableName:'HUT_ZIMType',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,panelHeight:150" Span="4" NewRow="True" />
                                                ...
                                                <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContIMNO1" MaxLength="0" Width="150" Span="1" NewRow="True" ReadOnly="False" RowSpan="1" Visible="True" />
                                                 <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="infocombobox" FieldName="ContIMType2" MaxLength="20" Width="80" Span="1" NewRow="False" ReadOnly="False" RowSpan="1" Visible="True" EditorOptions="valueField:'ID',textField:'IMNAME',remoteName:'sCustomersJobs.HUT_ZIMType',tableName:'HUT_ZIMType',pageSize:'-1',checkData:false,selectOnly:true,cacheRelationText:false,panelHeight:150" />
                                                <JQTools:JQFormColumn Alignment="left" Caption=" " Editor="text" FieldName="ContIMNO2" MaxLength="0" Width="150" Span="1" NewRow="False" ReadOnly="False" RowSpan="1" Visible="True" />
                                                 <JQTools:JQFormColumn Alignment="left" Caption="UserID" Editor="text" FieldName="UserID" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="False" Width="80" />
                                                 <JQTools:JQFormColumn Alignment="left" Caption="UpdateBy" Editor="text" FieldName="UpdateBy" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="False" Width="80" />
                                                 <JQTools:JQFormColumn Alignment="left" Caption="UpdateDate" Editor="text" FieldName="UpdateDate" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="False" Width="80" />
                                             </Columns>
                                     ...
                                     <JQTools:JQValidate ID="JQValidate3" runat="server" BindingObjectID="DFContactPerson" EnableTheming="True">
                                         <Columns>
                                             ...
                                             <JQTools:JQValidateColumn CheckNull="True" FieldName="ContactMobile1" RemoteMethod="False" ValidateType="None" CheckMethod="CheckContactMobile1" ValidateMessage="格式不對！" />
                                  ...
                                  <div style="padding:10px" title="檔案管理">
                                     <JQTools:JQDataGrid ID="DGCustomerFile" runat="server" AllowAdd="True" AllowDelete="True" AllowUpdate="True" AlwaysClose="True" AutoApply="False" BufferView="False" CheckOnSelect="False" ColumnsHibeable="False" DataMember="HUT_CustomerFile" DeleteCommandVisible="True" DuplicateCheck="False" EditDialogID="JQDialogCustomerFile" EditMode="Dialog" EditOnEnter="True" InsertCommandVisible="False" MultiSelect="False" NotInitGrid="False" OnUpdate="" PageList="10,20,30,40,50" PageSize="10" Pagination="True" ParentObjectID="dataFormMaster" QueryAutoColumn="False" QueryLeft="15px" QueryMode="Panel" QueryTitle="" QueryTop="50px" RecordLock="False" RecordLockMode="None" RemoteName="sCustomersJobs.HUT_Customer" RowNumbers="True" Title="" TotalCaption="Total:" UpdateCommandVisible="False" ViewCommandVisible="False" Width="500px" Height="320px" OnDelete="OnDeletFile">
                                         <Columns>
                                             <JQTools:JQGridColumn Alignment="left" Caption="檔案下載" Editor="text" EditorOptions="" FieldName="CustFile" Format="download,folder:Files/Hunter/Customer" MaxLength="150"  ReadOnly="False" Width="260" />
                                             <JQTools:JQGridColumn Alignment="center" Caption="建立時間" Editor="text" FieldName="UpdateDate" Format="yyyy/mm/dd HH:MM" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="True" Visible="True" Width="95">
                                             </JQTools:JQGridColumn>
                                     ...
                                     <JQTools:JQDialog ID="JQDialogCustomerFile" runat="server" BindingObjectID="DFCustomerFile" DialogLeft="240px" DialogTop="120px" Title="客戶檔案維護" Width="550px">
                                         <JQTools:JQDataForm ID="DFCustomerFile" runat="server" AlwaysReadOnly="False" Closed="False" ContinueAdd="False" DataMember="HUT_CustomerFile" disapply="False" DivFramed="False" DuplicateCheck="False" HorizontalColumnsCount="1" HorizontalGap="0" IsAutoPageClose="False" IsAutoPause="False" IsAutoSubmit="False" IsNotifyOFF="False" IsRejectNotify="False" IsRejectON="False" IsShowFlowIcon="False" OnApplied="OnAppliedCustomerFile" ParentObjectID="dataFormMaster" RemoteName="sCustomersJobs.HUT_Customer" ShowApplyButton="False" ValidateStyle="Hint" VerticalGap="0" OnApply="OnApplyCustomerFile">
                                             <Columns>
                                                 <JQTools:JQFormColumn Alignment="left" Caption="AutoKey" Editor="text" FieldName="AutoKey" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="False" Width="80" />
                                                 <JQTools:JQFormColumn Alignment="left" Caption="CustID" Editor="text" FieldName="CustID" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="False" Width="80" />
                                                 <JQTools:JQFormColumn Alignment="left" Caption="檔案上傳" Editor="infofileupload" FieldName="CustFile" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="True" Width="400" EditorOptions="filter:'docx|doc|xlsx|xls|jpg|jpeg|png|bmp|gif|pptx|ppt|pdf|image|tif|txt',isAutoNum:true,upLoadFolder:'Files/Hunter/Customer',showButton:true,showLocalFile:true,fileSizeLimited:'1000'" />
                                                 <JQTools:JQFormColumn Alignment="left" Caption="UserID" Editor="text" FieldName="UserID" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="False" Width="80" />
                                                 <JQTools:JQFormColumn Alignment="left" Caption="UpdateBy" Editor="text" FieldName="UpdateBy" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="False" Width="80" />
                                                 <JQTools:JQFormColumn Alignment="left" Caption="UpdateDate" Editor="text" FieldName="UpdateDate" MaxLength="0" NewRow="False" ReadOnly="False" RowSpan="1" Span="1" Visible="False" Width="80" />
                                             </Columns>
