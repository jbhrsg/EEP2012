     ...
     <script>                                
         ...
         function queryGrid(dg) {//查詢後添加固定條件
             ...
             //if (where.length > 0) {
                 ...
                 var url = "../JB_ADMIN/REPORT/Media/JBERP_R_SalesDetailsReportView.aspx?SDate=" + JQDate1 + "&EDate=" + JQDate2 + "&SalesEmployeeID=" + SalesEmployeeID + "&SalesTypeID=" + SalesTypeID + "&SalesTypeText=" + SalesTypeText + "&NewsTypeID=" + NewsTypeID + "&CustNO=" + CustNO + "&Sort=" + Sort;
...
&nbsp;<div id="Dialog_dataGridMasterData">
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="sR_SalesDetails.ERPSalesDetails" runat="server" AutoApply="True"
                ...
                Title="" ReportFileName="~/JB_ADMIN/JBERP_R_SalesDetails.rdlc" QueryMode="Panel" DeleteCommandVisible="False" UpdateCommandVisible="False" ViewCommandVisible="False" AlwaysClose="True" >
                <Columns>
