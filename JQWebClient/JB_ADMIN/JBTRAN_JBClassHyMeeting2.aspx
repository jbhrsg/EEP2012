<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JBTRAN_JBClassHyMeeting2.aspx.cs" Inherits="Template_JQuerySingle1" %>
         ...
         function OnLoadSuccess_dataGridView() {
             if (!$(this).data('firstLoad') && $(this).data('firstLoad', true)) {
                 //var groupid = getClientInfo("_groupid");
                     ...
                     where = where + "coscode='20160000'";
                     $('#dataGridView').datagrid('setWhere', where);
                     $($('#querydataGridView').find('input')[0]).combobox('setValue', '20160000');
