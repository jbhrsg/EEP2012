                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td style="width: 170px">
                                <JQTools:JQOptions ID="JQOptions1" runat="server" OpenDialog="False" Width="180px" DialogWidth="200" OnSelect="ControlShow">
                                    <Items>
                            ...
                            <td>
                                <div id="divFullSearch">
                                    ...
                                    &nbsp;(★請輸入關鍵字:以 , 區隔)<asp:TextBox ID="txtString" runat="server" Width="300px"></asp:TextBox>
                                            ...
                                            <td style="width: 130px"><JQTools:JQOptions ID="JQOptions2" runat="server" OpenDialog="False" DialogWidth="140" Width="120px">
                                    <Items>
