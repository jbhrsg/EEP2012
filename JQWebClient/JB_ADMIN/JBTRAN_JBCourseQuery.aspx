<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JBTRAN_JBCourseQuery.aspx.cs" Inherits="Template_JQuerySingle1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="sJBCourseQuery.JBClassStudentList" runat="server" AutoApply="True"
                DataMember="JBClassStudentList" Pagination="True" QueryTitle="人資活動課程查詢"
                Title="" AllowAdd="False" AllowDelete="False" AllowUpdate="False" AlwaysClose="True" BufferView="False" CheckOnSelect="True" ColumnsHibeable="False" DeleteCommandVisible="False" DuplicateCheck="False" EditMode="Dialog" EditOnEnter="True" InsertCommandVisible="False" MultiSelect="False" NotInitGrid="False" PageList="10,20,30,40,50" PageSize="20" QueryAutoColumn="False" QueryLeft="" QueryMode="Fuzzy" QueryTop="" RecordLock="False" RecordLockMode="None" RowNumbers="True" TotalCaption="Total:" UpdateCommandVisible="False" ViewCommandVisible="True" Width="1280px">
                <Columns>
                    <JQTools:JQGridColumn Alignment="left" Caption="課程名稱" Editor="text" FieldName="descr" Format="" MaxLength="0" Width="150" />
                    <JQTools:JQGridColumn Alignment="left" Caption="公司名稱" Editor="text" FieldName="company" Format="" MaxLength="0" Width="180" />
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="職位別" Editor="text" FieldName="inform" Format="" MaxLength="0" Width="60" />
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="地址" Editor="text" FieldName="address" Format="" MaxLength="0" Width="100" />
                    <JQTools:JQGridColumn Alignment="left" Caption="信箱" Editor="text" FieldName="mail" Format="" MaxLength="0" Width="150" />
                    <JQTools:JQGridColumn Alignment="left" Caption="會員" Editor="text" FieldName="member" Format="" MaxLength="0" Width="50" />
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="education" Editor="text" FieldName="education" Format="" MaxLength="0" Width="120" Visible="False" />
                    <JQTools:JQGridColumn Alignment="left" Caption="class" Editor="text" FieldName="class" Format="" MaxLength="0" Width="120" Visible="False" />
                    <JQTools:JQGridColumn Alignment="left" Caption="method" Editor="text" FieldName="method" Format="" MaxLength="0" Width="120" Visible="False" />
