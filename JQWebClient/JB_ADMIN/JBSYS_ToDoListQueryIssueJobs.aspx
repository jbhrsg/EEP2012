    ...
    <form id="form1" runat="server">
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridView" data-options="pagination:true,view:commandview" RemoteName="sSYS_TodoList.View_SYS_TODOLIST" runat="server" AutoApply="False"
                ...
                Title="待辦事項查詢" AllowAdd="False" AllowDelete="False" AllowUpdate="False" AlwaysClose="False" CheckOnSelect="True" ColumnsHibeable="False" DeleteCommandVisible="False" DuplicateCheck="False" EditMode="Dialog" EditOnEnter="True" InsertCommandVisible="False" MultiSelect="False" PageList="20,30,40,50,60" PageSize="10" QueryAutoColumn="False" QueryLeft="50px" QueryMode="Window" QueryTop="50px" RecordLock="False" RecordLockMode="None" TotalCaption="Total:" UpdateCommandVisible="False" ViewCommandVisible="True" Width="1020px">
                <Columns>
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="申請單號" Editor="text" FieldName="BILLNO" Format="" MaxLength="0" Width="80" />
                ...
                <QueryColumns>
                    <JQTools:JQQueryColumn AndOr="and" Caption="流程名稱" Condition="=" DataType="string" Editor="infocombobox" EditorOptions="valueField:'FLOW_DESC',textField:'FLOW_DESC',remoteName:'sSYS_TodoList.Flow_Desc',tableName:'Flow_Desc',pageSize:'-1',checkData:false,selectOnly:false,cacheRelationText:false,panelHeight:200" FieldName="FLOW_DESC" IsNvarChar="False" NewLine="False" RemoteMethod="False" Width="125" />
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="停留小時大於" Condition="&gt;=" DataType="number" Editor="text" FieldName="HOURS" IsNvarChar="False" NewLine="True" RemoteMethod="False" Width="125" />
                </QueryColumns>
            </JQTools:JQDataGrid>
