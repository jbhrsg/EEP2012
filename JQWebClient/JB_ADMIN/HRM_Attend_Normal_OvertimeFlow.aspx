<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HRM_Attend_Normal_OvertimeFlow.aspx.cs" Inherits="Template_JQuerySingle1" %>
...
<head runat="server">
    ...
    <script>
        ...
        //4. 判斷加班日期是否已有鎖檔紀錄
        //5. 判斷加班時數
        //6. 判斷加班資料(EMPLOYEE_ID/OVERTIME_DATE_TIME_BEGIN/OVERTIME_DATE_TIME_END)申請的時段內是否已有存在的加班資料
        ...
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="_HRM_Attend_Normal_Overtime.HRM_ATTEND_OVERTIME_DATA" runat="server" AutoApply="True"
                ...
                <Columns>
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="加班比率代碼" Editor="text" FieldName="OVERTIME_RATE_CODE" Format="" MaxLength="0" Width="80" Sortable="True" />
                    <JQTools:JQGridColumn Alignment="left" Caption="加班比率" Editor="text" FieldName="OVERTIME_RATE_CNAME" Format="" MaxLength="0" Width="120" Sortable="True" />
            ...
            <JQTools:JQDialog ID="JQDialog1" runat="server" BindingObjectID="dataFormMaster" Title="加班單" Width="700px">
                <JQTools:JQDataForm ID="dataFormMaster" runat="server" DataMember="HRM_ATTEND_OVERTIME_DATA" HorizontalColumnsCount="2" RemoteName="_HRM_Attend_Normal_Overtime.HRM_ATTEND_OVERTIME_DATA" Closed="False" ContinueAdd="True" disapply="False" DuplicateCheck="False" IsAutoPageClose="False" IsAutoSubmit="True" IsNotifyOFF="False" IsRejectNotify="False" OnApply="checkOvertimeData" IsRejectON="False" IsShowFlowIcon="True" ShowApplyButton="False" ValidateStyle="Hint" OnApplied="gridReload">
                    <Columns>
                        <JQTools:JQFormColumn Alignment="left" Caption="加班資料流水碼" Editor="numberbox" FieldName="OVERTIME_ID" Format="" Width="180" Visible="False" MaxLength="0" />
                        ...
                        <JQTools:JQFormColumn Alignment="left" Caption="加班比率流水號" Editor="numberbox" FieldName="OVERTIME_RATE_ID" Format="" Width="180" Visible="False" />
                        <JQTools:JQFormColumn Alignment="left" Caption="加班比率" Editor="inforefval" FieldName="OVERTIME_RATE_CODE" Format="" MaxLength="0" Width="180" EditorOptions="title:'JQRefval',panelWidth:350,remoteName:'_HRM_Attend_Share.HRM_ATTEND_OVERTIME_RATE',tableName:'HRM_ATTEND_OVERTIME_RATE',columns:[{field:'OVERTIME_RATE_CODE',title:'加班比率代碼',width:80,align:'left',table:'',queryCondition:''},{field:'OVERTIME_RATE_CNAME',title:'加班比率中文名稱',width:80,align:'left',table:'',queryCondition:''}],columnMatches:[{field:'OVERTIME_RATE_ID',value:'OVERTIME_RATE_ID'}],whereItems:[],valueField:'OVERTIME_RATE_CODE',textField:'OVERTIME_RATE_CNAME',valueFieldCaption:'加班比率代碼',textFieldCaption:'加班比率中文名稱',cacheRelationText:true,checkData:true,showValueAndText:false,selectOnly:false" Visible="False" />
                ...
                <JQTools:JQDefault ID="defaultMaster" runat="server" BindingObjectID="dataFormMaster" EnableTheming="True">
                    <Columns>
                        ...
                        <JQTools:JQDefaultColumn CarryOn="False" DefaultMethod="" DefaultValue="_usercode" FieldName="EMPLOYEE_CODE" RemoteMethod="True" />
