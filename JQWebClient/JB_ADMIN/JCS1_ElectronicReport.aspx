<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JCS1_ElectronicReport.aspx.cs" Inherits="Template_JQuerySingle1" %>
    ...
    <title></title>
     <script>                                
         ...
         function queryGrid(dg) {//查詢後添加固定條件
             ...
             var InvoiceType = $("#InvoiceType_Query").options('getValue');//沖銷方式
             var IsElec = $("#IsElec_Query").options('getValue');//已匯出?

             var url = "../JB_ADMIN/REPORT/JCS1/ElectronicReportView.aspx?YM=" + YearMonth + "&CustID=" + CustomerID + "&InvoiceType=" + InvoiceType + "&IsElec=" + IsElec;
...
&nbsp;<div id="Dialog_dataGridMasterData">
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="sJCS1.BillPayMaster" runat="server" AutoApply="True"
                ...
                <QueryColumns>
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="沖銷方式" Condition="%" DataType="string" Editor="infooptions" EditorOptions="title:'JQOptions',panelWidth:190,remoteName:'',tableName:'',valueField:'',textField:'',columnCount:3,multiSelect:false,openDialog:false,selectAll:false,selectOnly:false,items:[{text:'不拘',value:''},{text:'二聯式',value:'0'},{text:'三聯式',value:'4'}]" FieldName="InvoiceType" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="已匯出?" Condition="%" DataType="string" Editor="infooptions" EditorOptions="title:'JQOptions',panelWidth:140,remoteName:'',tableName:'',valueField:'',textField:'',columnCount:3,multiSelect:false,openDialog:false,selectAll:false,selectOnly:false,items:[{text:'不拘',value:''},{text:'否',value:'0'},{text:'是',value:'1'}]"  FieldName="IsElec" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
                </QueryColumns>
            </JQTools:JQDataGrid>
            </div>
        </div>
