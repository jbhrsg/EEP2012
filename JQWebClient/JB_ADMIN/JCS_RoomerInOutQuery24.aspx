<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JCS_RoomerInOutQuery24.aspx.cs" Inherits="Template_JQuerySingle1" %>
        ...
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="sJCSOutQuery.RoomerInOutQuery" runat="server" AutoApply="True"
                ...
                <Columns>
                    ...
                    <JQTools:JQGridColumn Alignment="left" Editor="text" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="120" Caption="最近刷卡日期時間" FieldName="CardTimeLast">
