<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JCS_RoomerInOutQuery.aspx.cs" Inherits="Template_JQuerySingle1" %>
        ...
        <div>
            ...
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="sJCSOutQuery.RoomerInOutQuery" runat="server" AutoApply="True"
                ...
                <Columns>
                    ...
                    <JQTools:JQGridColumn Alignment="left" Caption="最後刷出時間" Editor="text" FieldName="CardTimeLastOut" Format="" MaxLength="0" Width="130" Sortable="True" />
                    <JQTools:JQGridColumn Alignment="left" Caption="最後刷進時間" Editor="text" FieldName="CardTimeLastIn" Format="" MaxLength="0" Width="130" Sortable="True" />
                    ...
                    <JQTools:JQGridColumn Alignment="right" Caption="在宿時數" Editor="numberbox" FieldName="HoursLastIN" Frozen="False" IsNvarChar="False" MaxLength="0" QueryCondition="" ReadOnly="False" Sortable="False" Visible="True" Width="65">
                    </JQTools:JQGridColumn>
