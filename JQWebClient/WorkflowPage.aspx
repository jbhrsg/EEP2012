    ...
    <div id="tabsWorkFlow" class="easyui-tabs" data-options="fit:true,plain:true">
        <div title="111">
            <div class="easyui-layout" data-options="fit:true">
                ...
                <div data-options="region:'center',border:false">
                    <table id="dgInbox" title="收件代办" style="width: auto" fit="true" pagination="false" rownumbers="true" singleselect="false"></table>
                </div>
            </div>
        </div>
        <div title="222">
            <div class="easyui-layout" data-options="fit:true">
                ...
                <div data-options="region:'center',border:false">
                    <div id="divOutbox" class="easyui-panel" data-options="fit:true">
                        <table id="dgOutbox" title="送件经办" fit="true" pagination="false" rownumbers="true" singleselect="true"></table>
                    </div>
                    <div id="divFlowRunOver">
                        <table id="dgFlowRunOver" title="已结案" fit="true" pagination="false" rownumbers="true" singleselect="true"></table>
                    </div>
                </div>
            </div>
        </div>
        <div title="333">
            <div class="easyui-layout" data-options="fit:true">
                ...
                <div data-options="region:'center',border:false">
                    <table id="dgNotify" title="通知事项" style="width: auto" fit="true" pagination="false" rownumbers="true" singleselect="true"></table>
                </div>
            </div>
        </div>
        <div title="444">
                ...
                <div data-options="region:'north',split:false,border:false" style="height: 35px">
                    <table style="height: 100%; width: 100%">
                        <tr>
                            ...
                            <td style="width: 100px">
                                <input id="cbNotOvertime_Delay" type="checkbox" onclick="cbNotOvertimeChanged(this)" /><label id="lNotOvertime_Delay" style="position: relative; top: -3px">NotOvertime</label>
                            </td>
                            <td style="width: 80px">
                                <a id="btOvertime_Query" href="#" class="easyui-linkbutton">Query</a>
                            </td>
                            <td style="width: 80px">
                                <a id="btnTransfer_Delay" href="#" class="easyui-linkbutton">Transfer</a>
                            </td>
                            <td>
                                <input id="cbOvertime_ShowAll" type="checkbox" onclick="cbOvertime_ShowAllChanged(this)" /><label id="lNotOvertime_showALl" style="position: relative; top: -3px">show All</label>
                            </td>
                        </tr>
                    </table>
                </div>
                <div data-options="region:'center',border:false">
                    <table id="dgDelay" title="逾时事项" style="width: auto" fit="true" pagination="false" rownumbers="true" singleselect="true"></table>
                </div>
            </div>
        </div>
    </div>
