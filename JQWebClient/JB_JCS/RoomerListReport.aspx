<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoomerListReport.aspx.cs" Inherits="Template_JQuerySingle1" %>
    ...
    <title></title>
     <script>                                
         ...
         function OnLoadSuccessGV() {
             ...
             $("#TranType_Query").options('setValue', 1);
         ...
         function queryGrid(dg) {//查詢後添加固定條件
             ...
             var TranType = $("#TranType_Query").options('getValue');//房客狀態
             var InOutStatus = $("#InOutStatus_Query").options('getValue');//進出狀態	
             var RoomID = $("#RoomID_Query").numberbox('getValue');//房號	

             var url = "../JB_JCS/REPORT/JCS/RoomerReportView.aspx?DormID=" + DormID + "&CustID=" + CustomerID + "&TranType=" + TranType + "&InOutStatus=" + InOutStatus + "&RoomID=" + RoomID;
...
&nbsp;<div id="Dialog_dataGridMasterData">
            <JQTools:JQDataGrid ID="dataGridMaster" data-options="pagination:true,view:commandview" RemoteName="sJCS.infoRoomerData" runat="server" AutoApply="True"
                ...
                <QueryColumns>
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="房客狀態" Condition="%" DataType="string" Editor="infooptions" EditorOptions="title:'JQOptions',panelWidth:190,remoteName:'sJCS.infoRoomerType',tableName:'infoRoomerType',valueField:'TypeID',textField:'Type',columnCount:3,multiSelect:false,openDialog:false,selectAll:false,selectOnly:false,items:[]" FieldName="TranType" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
                    ...
                    <JQTools:JQQueryColumn AndOr="and" Caption="進出狀態" Condition="%" DataType="string" Editor="infooptions" EditorOptions="title:'JQOptions',panelWidth:140,remoteName:'sJCS.infoInOutStatus',tableName:'infoInOutStatus',valueField:'StatusID',textField:'Status',columnCount:3,multiSelect:false,openDialog:false,selectAll:false,selectOnly:false,items:[]"  FieldName="InOutStatus" IsNvarChar="False" NewLine="False" RemoteMethod="False" RowSpan="0" Span="0" Width="125" />
