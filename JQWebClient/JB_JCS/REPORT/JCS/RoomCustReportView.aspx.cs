    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {                
                ...
                string ReportPath = "JB_JCS/REPORT/JCS/RoomCustList.rdlc";//報表路徑

                var parameters = new List<object>();
                parameters.Add(DormID + "," + CustID + ","+ RoomID);
                var obj = client.CallMethod(EFClientTools.ClientUtility.ClientInfo, "sJCS", "procReportRoomCustList", parameters);
