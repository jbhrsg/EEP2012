        ...
        $(jq).each(function () {
            ...
            if (mode == 'weekly') {
                ...
                for (var i = 0; i < 7; i++) {
                    ...
                    //jbjob edit by GG
                    var dateCell = $("<td class='schedule-cell'>" + (date.getMonth() + 1) + "/" + date.getDate() + "</td>").appendTo(dateRow).data("date", date);
