...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //    if ($("#ddlSolution").next("span").children("input")[1].value == "JBADMIN") {
...
<body id="mainBodyLayout" class="easyui-layout">
    <form id="form1" runat="server">
        <div style="width: 1280px; height: 20px; background-image: url(img/head.jpg);" title="" data-options="region:'north',split:false" border="false">
        ...
        <div data-options="region:'center'">
            <div id="tabsMain" class="easyui-tabs" fit="true">
                <div id="MainTab" title="首頁" style="background-image: url(img/main.jpg);">
                    <JQTools:JQMetro ID="JQMetro1" runat="server" DBAlias="ERPS" RootValue="" SubFolder="False" />
                    <%--競賽圖 --%>
                    <%--<iframe id="main" name="main"  src="JB_ADMIN/JBERP_CompetitionOutput1.aspx" frameborder="0"
                            marginheight="0" marginwidth="2" width="100%" align="right" height="100%"></iframe>--%>

                    <asp:Image ID="MainImg" runat="server" class="maincenter" Width="1" Height="1" src="img/img0.png" visible="false"/>
