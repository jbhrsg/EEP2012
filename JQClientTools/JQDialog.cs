...
namespace JQClientTools
{
    public class JQDialog : Panel
    {
        public JQDialog()
        {
            #region 2014/07/22ShowSubmitDiv更動
            ShowSubmitDiv = true;
            #endregion
            Closed = true;
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            if (!this.DesignMode)
            {
                ...
                //後來
                if (ShowSubmitDiv) writer.AddAttribute(HtmlTextWriterAttribute.Style, "text-align: center; padding: 5px");
                else writer.AddAttribute(HtmlTextWriterAttribute.Style, "text-align: center; padding: 5px; display:none;");
