...
namespace sJCS1EmpAttendance
{
    public partial class Component : DataModule
    {
        ...
        public object[] CheckEmpID(object[] objParam)
        {
            ...
            IDbConnection connection = (IDbConnection)AllocateConnection("JCS1");
            ...
            try
            {
                ...
                string sql = "SELECT COUNT(*) AS CNT FROM JCS.dbo.Employee WHERE EmpID = '" + EmpID + "'";
            ...
            {
                transaction.Commit();
                ReleaseConnection("JCS", connection);
            }
        ...
        public object[] GetEmpListPeriod(object[] objParam)
        {
            ...
            {
                ReleaseConnection("JCS1", connection);
            }
            return new object[] { 0, js }; ;
