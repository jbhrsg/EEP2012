    ...
    public partial class Component : DataModule
    {
        ...
        public object[] CheckSetUpFeeStatus(object[] objParam)
        {
            ...
            try
            {
                ...
                string sql = "SELECT COUNT(ShortTermNO) as cnt FROM [192.168.1.41].FWCRMJS.DBO.EmployeeFees WHERE ShortTermNO = '" + ShortTermNO + "'";
        ...
        public object[] CheckSetUpFeeStatusBill(object[] objParam)
        {
            ...
            {
                string ShortTermNO = objParam[0].ToString();
                string sql = "SELECT COUNT(ShortTermNO) as cnt FROM [192.168.1.41].FWCRMJS.DBO.FeeSetUpM WHERE left(ShortTermNO,8) = '" + ShortTermNO + "'";
                DataSet dsTemp = this.ExecuteSql(sql, connection, transaction);
                string cnt = dsTemp.Tables[0].Rows[0]["cnt"].ToString();
                js = JsonConvert.SerializeObject(cnt, Formatting.Indented);
            }
        ...
        public object[] procInsertFeeSetUpMbyEEP(object[] objParam)
        {
            ...
            try
            {
                string sql = "EXEC [192.168.1.41].FWCRMJS.dbo.procInsertFeeSetUpMbyEEP '" + FeeID + "','" + YearMonth + "','" + FeeSDate + "','" + FeeEDate + "','" + ShortTermAmount + "','" + ShortTermNO + "','" + DormID + "','" + UserName + "'";
