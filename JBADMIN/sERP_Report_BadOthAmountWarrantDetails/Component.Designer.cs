namespace sERP_Report_BadOthAmountWarrantDetails
{
    partial class Component
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.WarrantDetails = new Srvtools.InfoCommand();
            this.Customer = new Srvtools.InfoCommand();
            this.infoConnection2 = new Srvtools.InfoConnection();
            this.InsGroup = new Srvtools.InfoCommand();
