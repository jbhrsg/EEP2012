namespace sCON_HOBBY
{
    partial class Component
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.CON_SHARECODE.CommandText = "SELECT dbo.[CON_SHARECODE].* FROM dbo.[CON_SHARECODE]\r\nWHERE FIELDNAME=\'CONTACT_H" +
    "OBBY\'";
            ...
            this.ucCON_SHARECODE.BeforeInsert += new Srvtools.UpdateComponentBeforeInsertEventHandler(this.ucCON_SHARECODE_BeforeInsert);
            this.ucCON_SHARECODE.BeforeModify += new Srvtools.UpdateComponentBeforeModifyEventHandler(this.ucCON_SHARECODE_BeforeModify);
            // 
            // View_CON_SHARECODE
            // 
